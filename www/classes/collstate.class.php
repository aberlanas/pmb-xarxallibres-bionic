...
// +-------------------------------------------------+
// $Id: collstate.class.php,v 1.25 2017-06-22 10:19:48 dgoron Exp $
...
class collstate {
	...
	public function get_bulletins_list() {
		...
		$html = str_replace('!!statut_libelle!!', "<span class='".$this->statut_class_html."'  style='margin-right: 3px;'><img src='./images/spacer.gif' width='10' height='10' /></span>".$this->statut_gestion_libelle, $html);
