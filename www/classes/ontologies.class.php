...
// +-------------------------------------------------+
// $Id: ontologies.class.php,v 1.2 2017-06-16 09:33:39 mbertin Exp $
...
class ontologies {
	...
	public function get_admin_menu(){
		...
		<span".ongletSelect("categ=ontologies&ontology_id=".$ontology->get_id()).">
			<a title='".htmlentities($ontology->get_name(),ENT_QUOTES,$charset)."' href='./admin.php?categ=ontologies&ontology_id=".$ontology->get_id()."'>
	...
	public function get_list(){
		...
		foreach($this->ontologies as $ontology){
			...
			$parity += 1;
			$tr_javascript=" onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='$pair_impair'\" onclick=\"document.location='./admin.php?categ=ontologies&sub=general&act=edit&ontology_id=".$ontology->get_id()."';\" ";
