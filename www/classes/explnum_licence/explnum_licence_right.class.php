...
// +-------------------------------------------------+
// $Id: explnum_licence_right.class.php,v 1.3 2017-07-19 15:43:18 vtouchard Exp $
...
class explnum_licence_right {
	...
	public function get_form() {
		...
		if(!$this->id){
			...
			$form = str_replace('!!explnum_licence_right_label!!', '', $form);
			$form = str_replace('!!explnum_licence_right_logo_url!!', '', $form);
			$form = str_replace('!!explnum_licence_right_explanation!!', '', $form);
			...
			$form = str_replace('!!explnum_licence_right_label!!', htmlentities($this->label, ENT_QUOTES, $charset), $form);
			$form = str_replace('!!explnum_licence_right_logo_url!!', htmlentities($this->logo_url, ENT_QUOTES, $charset), $form);
			$form = str_replace('!!explnum_licence_right_explanation!!', htmlentities($this->explanation, ENT_QUOTES, $charset), $form);
