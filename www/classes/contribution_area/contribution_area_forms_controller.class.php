...
// +-------------------------------------------------+
// $Id: contribution_area_forms_controller.class.php,v 1.5.2.2 2017-09-14 14:45:29 tsamson Exp $
 				...
 				if(is_array($form_parameters)){
	 				foreach($form_parameters as $prop => $pValues){
	 					...
	 					$properties[] = array(
	 						...
	 						'pmb_name' => self::$classes_properties[$entity->pmb_name][$prop]->pmb_name
	 					);
		...
		<div class="row">
			<span class="item-expand">
				<a href="#" onclick="expandAll();return false;">
					<img src="./images/expand_all.gif" border="0" id="expandall">
				</a>
				<a href="#" onclick="collapseAll();return false;">
					<img src="./images/collapse_all.gif" border="0" id="collapseall">
				</a>
			</span>
		</div>
		<div class="row">
