...
// +-------------------------------------------------+
// $Id: contribution_area.class.php,v 1.6.2.1 2017-09-14 14:45:29 tsamson Exp $
...
class contribution_area {
	...
	public function get_definition_form(){
		...
		$form = str_replace ("!!graph_data_store!!",encoding_normalize::json_encode(contribution_area::get_graph_store_data()),$form);
	...
	public static function get_pmb_entities() {
		...
		foreach($classes_array as $entity){
			if (!is_array($entity->flags) || !in_array("pmb_entity", $entity->flags)) {
				continue;
			}
