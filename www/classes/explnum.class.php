...
// +-------------------------------------------------+
// $Id: explnum.class.php,v 1.90.2.3 2017-12-14 10:19:54 jpermanne Exp $
...
if (! defined('EXPLNUM_CLASS')) {
	...
	class explnum {
		...
		// constructeur
		function __construct($id = 0, $id_notice = 0, $id_bulletin = 0) {
			global $dbh, $pmb_indexation_docnum_default, $deflt_explnum_statut, $deflt_lenders;
