...
// +-------------------------------------------------+
// $Id: nomenclature_records_tabs.class.php,v 1.7 2016-12-20 09:59:09 dgoron Exp $
...
class nomenclature_records_tabs extends records_tabs {
	...
	protected function get_tab_submanifestations_docnums(){
		...
		$vedette_composee_found = vedette_composee::get_vedettes_built_with_element($concept_blank_id, 'concept');
