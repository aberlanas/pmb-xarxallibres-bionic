...
// +-------------------------------------------------+
// $Id: authorities_statuts.class.php,v 1.13 2017-06-20 12:45:34 dgoron Exp $
	...
	public static function show_list(){
		...
		foreach(static::$statuts as $id => $statut){
			...
			<tr  class='$pair_impair' style='cursor: pointer' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='$pair_impair'\">
				<td onclick='document.location=\"./admin.php?categ=authorities&sub=statuts&action=edit&id=".$id."\"'><span class='".$statut['class_html']."' style='margin-right:3px;'><img width='10' height='10' src='./images/spacer.gif'/></span>".htmlentities($statut['label'], ENT_QUOTES, $charset)."</td>
			</tr>";
			$i++;
		}
		print "
