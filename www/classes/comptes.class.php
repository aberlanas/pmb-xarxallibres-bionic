...
// +-------------------------------------------------+
// $Id: comptes.class.php,v 1.16 2017-01-25 16:43:50 dgoron Exp $
...
class comptes {
    ...
    public function record_transaction($date_prevue,$montant,$sens,$comment="",$encaissement=0,$transactype=0) {
    	global $msg;
