...
// +-------------------------------------------------+
// $Id: scheduler_planning.class.php,v 1.2.2.4 2018-02-01 17:00:44 mbertin Exp $
...
class scheduler_planning {
	...
	public function get_form() {
		...
		$form=str_replace("!!help!!",
			...
			<img border='0' class='center' title='Aide...' alt='Aide...' src='".$base_path."/images/aide.gif' /></a>",$form);
