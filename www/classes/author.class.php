...
// +-------------------------------------------------+
// $Id: author.class.php,v 1.140 2017-07-17 15:52:22 dgoron Exp $
		...
		public function getData() {
			...
			if ($this->id) {
				...
				if (pmb_mysql_num_rows($result)) {
					...
					if ($row->author_web)
						$this->author_web_link = " <a href='$row->author_web' target=_blank><img src='./images/globe.gif' border=0 /></a>";
					else
...
// 			}
		...
		public function replace($by, $link_save = 0) {
			...
			vedette_composee::replace(AUT_TABLE_AUTHORS, $this->id, $by);
		...
		public static function update_index($id, $datatype = 'all') {
			...
			if(count($tu_ids)) {
				...
				$indexation_authority->delete_objects_index($tu_ids, 'author');
				titre_uniforme::set_deleted_index(true);
