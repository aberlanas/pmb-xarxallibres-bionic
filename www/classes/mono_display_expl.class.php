...
// +-------------------------------------------------+
// $Id: mono_display_expl.class.php,v 1.15 2017-07-19 12:06:19 dgoron Exp $
...
class mono_display_expl {
	...
	public function init_javascript() {
		...
		if($pmb_recherche_ajax_mode && $this->ajax_mode){
	        ...
	        <img src='./images/basket_small_20x20.gif' align='middle' alt='basket' title=\"${msg[400]}\" $cart_click $cart_over_out>
	        !!ISBD!!
	 		</div>";
