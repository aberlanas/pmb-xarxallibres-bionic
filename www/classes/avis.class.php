...
// +-------------------------------------------------+
// $Id: avis.class.php,v 1.3.2.1 2017-12-03 18:10:54 Alexandre Exp $
...
class avis {
	...
	public static function get_display_review($avis) {
		...
		if (!$avis->valide)
			$display .=  "<font color='#CC0000'><span >$note<b>".htmlentities($avis->sujet,ENT_QUOTES,$charset)."</b></span></font>";
		else
			$display .=  "<font color='#00BB00'><span >$note<b>".htmlentities($avis->sujet,ENT_QUOTES,$charset)."</b></span></font>";
