...
// +-------------------------------------------------+
// $Id: subcollection.class.php,v 1.82 2017-07-17 15:52:22 dgoron Exp $
...
// ---------------------------------------------------------------
	...
	public function getData() {
		...
		if($this->id) {
			...
			if(pmb_mysql_num_rows($result)) {
				...
				if($row->subcollection_web) $this->subcollection_web_link = " <a href='$row->subcollection_web' target=_blank><img src='./images/globe.gif' border=0 /></a>";
	...
	public function replace($by,$link_save=0) {
		...
		vedette_composee::replace(AUT_TABLE_SUB_COLLECTIONS, $this->id, $by);
