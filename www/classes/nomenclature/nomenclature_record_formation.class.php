...
// +-------------------------------------------------+
// $Id: nomenclature_record_formation.class.php,v 1.24 2016-06-23 15:18:55 dgoron Exp $
...
class nomenclature_record_formation{
	...
	public function save_form($data) {
		...
		$this->exotic_instruments_note=stripslashes($data["exotic_instruments_note"]);
