...
// +-------------------------------------------------+
// $Id: facettes_root.class.php,v 1.12.2.1 2017-10-03 09:04:50 dgoron Exp $
...
abstract class facettes_root {
	...
	protected function get_display_not_clicked() {
		...
		if(is_array($this->not_clicked) && count($this->not_clicked)) {
			...
			$display_not_clicked .= "<input class='bouton' type='button' value='".htmlentities($msg["facette_filtre"],ENT_QUOTES,$charset)."' name='filtre' onClick='valid_facettes_multi()'>";
			if(static::get_compare_notice_active()){
