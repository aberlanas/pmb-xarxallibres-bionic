...
// +-------------------------------------------------+
// $Id: netbase.class.php,v 1.2.2.2 2017-12-28 14:29:57 dgoron Exp $
...
class netbase {
	...
	public static function get_display_progress($start=0, $count=0) {
		...
		$display = "<table border='0' align='center' width='$jauge_size' cellpadding='0'><tr><td class='jauge' width='100%'>";
		$display .= "<div class='jauge'><img src='../../images/jauge.png' width='$state' height='16px'></div></td></tr></table>";
			
		// calcul pourcentage avancement
		$percent = floor(($start/$count)*100);
			
		// affichage du % d'avancement et de l'état
		$display .= "<div align='center'>$percent%</div>";
		return $display;
	}
	...
	public static function get_display_final_progress() {
		...
		$display = "
			<table border='0' align='center' width='$table_size' cellpadding='0'>
				<tr>
					<td class='jauge'>
						<img src='../../images/jauge.png' width='$jauge_size' height='16'>
					</td>
				</tr>
			</table>
