...
// +-------------------------------------------------+
// $Id: onto_common_datatype_list_ui.class.php,v 1.2.2.1 2017-09-14 14:45:24 tsamson Exp $
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if(sizeof($datas)){
			...
			foreach($options_values as $id => $value){
				$options.= '<option value="'.$id.'"'.(in_array($id, $values) ? 'selected="selected"' : '').' >'.$value.'</option>';
			}
