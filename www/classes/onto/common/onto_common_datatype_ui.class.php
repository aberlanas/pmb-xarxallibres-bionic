...
// +-------------------------------------------------+
// $Id: onto_common_datatype_ui.class.php,v 1.20 2017-03-21 13:58:55 tsamson Exp $
	...
	public static function get_hidden_fields($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if(sizeof($datas)){
			...
			foreach($datas as $key=>$data){
				 ...
				 */
				$row=str_replace("!!onto_row_content_hidden_value!!",htmlentities((is_array($data->get_formated_value()) ? $data->get_formated_value()[0] : $data->get_formated_value()) ,ENT_QUOTES,$charset) ,$row);
