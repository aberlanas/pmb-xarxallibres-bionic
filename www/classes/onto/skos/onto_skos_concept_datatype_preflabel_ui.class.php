...
// +-------------------------------------------------+
// $Id: onto_skos_concept_datatype_preflabel_ui.class.php,v 1.8 2017-05-23 09:28:00 apetithomme Exp $
...
class onto_skos_concept_datatype_preflabel_ui extends onto_common_datatype_small_text_card_ui{
	...
	public static function get_form($item_uri, $property, $restrictions,$datas, $instance_name, $flag){
		...
		$vedette_ui=new vedette_ui(new vedette_composee($vedette_id, $grammar));
