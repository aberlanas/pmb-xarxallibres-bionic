...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_upload_directories_ui.class.php,v 1.1.2.2 2017-12-27 09:47:01 apetithomme Exp $
	...
	static public function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if(sizeof($datas)){
			...
			foreach ($datas as $data) {
				...
				$inside_row=str_replace('!!onto_row_memory_data!!', json_encode(static::$directories), $inside_row);
