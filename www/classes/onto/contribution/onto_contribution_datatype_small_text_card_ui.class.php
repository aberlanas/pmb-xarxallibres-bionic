...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_small_text_card_ui.class.php,v 1.2.2.1 2017-09-14 14:45:23 tsamson Exp $
	...
	public static function get_form($item_uri,$property, $restrictions,$datas, $instance_name,$flag) {
		...
		if(sizeof($datas)){
			...
			foreach($datas as $key=>$data){
				...
				$inside_row=str_replace("!!onto_row_content_small_text_value!!",htmlentities(pmb_utf8_array_decode($data->get_formated_value()) ,ENT_QUOTES,$charset) ,$inside_row);
