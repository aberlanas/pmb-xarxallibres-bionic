...
// +-------------------------------------------------+
// $Id: notice_form_mapper.class.php,v 1.2.4.1 2017-11-08 10:39:47 arenou Exp $
...
// 	        	}
                ...
                foreach($this->noticeObject->responsabilites['auteurs'] as $author){
                    ...
                    $authors_label[] = $authority->get_object_instance()->isbd_entry;
...
// 	        		$authors_label[] = $author['objet']->isbd_entry;
// 	        		$authors_id[] = $author['id'];
// 	        		$functions_id[] = $author['fonction'];
// 	        		$functions_label[] = $fonction->table[$author['fonction']];
// 	        	}
