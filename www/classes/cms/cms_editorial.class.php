...
// +-------------------------------------------------+
// $Id: cms_editorial.class.php,v 1.70.2.3 2017-12-12 15:04:08 tsamson Exp $
...
class cms_editorial extends cms_root {
	...
	protected function get_tab_field_insert($object_id, $infos, $order_fields, $isbd, $lang = '') {
		return "(".$object_id.", '".$this->type."', ".$infos["champ"].", ".$infos["ss_champ"].", ".$order_fields.", '".addslashes(trim($isbd))."', '".addslashes(trim($lang))."', ".$infos["pond"].", 0)";
	}
