...
// +-------------------------------------------------+
// $Id: cms_collections.class.php,v 1.16.2.3 2018-01-05 16:30:31 dgoron Exp $
...
class cms_collections extends cms_root{
	...
	public function get_documents_form($selected=array()){
		...
		<div id='collections_documents_form'>
			...
			<img id='expandall' border='0' src='./images/expand_all.gif'>
			<img id='collapseall' border='0' src='./images/collapse_all.gif'>
		";
		foreach($this->collections as $collection){ 
			...
			<div id='collection".$collection->id."' class='notice-parent'>				
				<img data='".$data."' src='./images/plus.gif' class='img_plus' name='imEx' id='collection".$collection->id."Img' title='".$msg['plus_detail']."' border='0'  hspace='3'>
