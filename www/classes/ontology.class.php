...
// +-------------------------------------------------+
// $Id: ontology.class.php,v 1.7 2017-07-05 15:27:40 tsamson Exp $
...
class ontology {
	...
	public function get_form(){
		...
		if($this->id){
			...
			$form = str_replace("!!delete_btn!!",confirmation_delete("./admin.php?categ=ontologies&sub=general&act=delete&ontology_id=")."<input class='bouton' type='button' value='$msg[supprimer]' onClick=\"javascript:confirmation_delete(".$this->id.",'".$this->name."')\" />",$form);
		}else{
	...
	public function exec_onto_framework($base_resource = "admin.php"){
		global $include_path;
