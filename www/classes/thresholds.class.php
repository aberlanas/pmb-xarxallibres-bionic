...
// +-------------------------------------------------+
// $Id: thresholds.class.php,v 1.2 2016-08-04 10:00:47 dgoron Exp $
	...
	public function get_display_content_list() {
		...
		foreach($this->thresholds as $threshold) {
			...
			$display .= "<tr ".$tr_javascript.">
				...
				<td align='center'>".htmlentities(number_format($threshold->get_amount(),'2','.',' '), ENT_QUOTES, $charset)." ".$pmb_gestion_devise."</td>
				<td align='center'>".($threshold->get_amount_tax_included() ? "X" : "")."</td>
