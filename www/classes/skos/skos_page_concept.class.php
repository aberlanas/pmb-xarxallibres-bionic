...
// +-------------------------------------------------+
// $Id: skos_page_concept.class.php,v 1.5.4.1 2017-12-06 15:34:36 dgoron Exp $
...
class skos_page_concept extends authority_page {
	...
	public function proceed($context = array()){
		...
		if ($authority_list_ui) $authority_list_ui->set_current_url($pmb_url_base.'autorites.php?categ=see&sub='.$sub.'&id='.$id.'&quoi='.$quoi);
