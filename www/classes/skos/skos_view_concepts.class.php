...
// +-------------------------------------------------+
// $Id: skos_view_concepts.class.php,v 1.7 2017-07-12 15:15:02 tsamson Exp $
...
class skos_view_concepts {
	...
	static public function get_narrowers_list($concepts_list) {
		...
		return self::render($datas, "skos_view_concepts_narrowers_list", 0);
	}
	...
	static public function get_broaders_list($concepts_list) {
		...
		return self::render($datas, "skos_view_concepts_broaders_list", 0);
	}
