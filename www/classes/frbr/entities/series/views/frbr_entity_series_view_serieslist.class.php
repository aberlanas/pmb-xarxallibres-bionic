...
// +-------------------------------------------------+
// $Id: frbr_entity_series_view_serieslist.class.php,v 1.2 2017-05-16 09:00:44 dgoron Exp $
...
{% endfor %}
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $serie_id){
				...
				$infos= $serie->format_datas();
				$render_datas['series'][]=$infos;
			}
		}
		//on rappelle le tout...
	...
	public function get_format_data_structure(){		
		...
		$series = array(
			...
			'children' => $this->prefix_var_tree(serie::get_format_data_structure(),"series[i]")
		);
		$format[] = $series;
