...
// +-------------------------------------------------+
// $Id: frbr_entity_series_view.class.php,v 1.2 2017-05-05 07:43:35 dgoron Exp $
...
<h3>{{serie.name}}</h3>
	...
	public function render($datas){	
		...
		$serie = new serie($datas[0]);
		$render_datas['serie'] = $serie->format_datas();
		//on rappelle le tout...
	...
	public function get_format_data_structure(){		
		...
		$serie = array(
			...
			'children' => $this->prefix_var_tree(serie::get_format_data_structure(),"serie")
		);
		$format[] = $serie;
