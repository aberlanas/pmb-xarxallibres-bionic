...
// +-------------------------------------------------+
// $Id: frbr_entity_indexint_view_indexintlist.class.php,v 1.2 2017-05-16 09:00:44 dgoron Exp $
...
{% endfor %}
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $indexint_id){
				$indexint = new indexint($indexint_id);
				$infos= $indexint->format_datas();
				$render_datas['indexint'][]=$infos;
			}
		}
		//on rappelle le tout...
	...
	public function get_format_data_structure(){		
		...
		$indexint = array(
			...
			'children' => $this->prefix_var_tree(indexint::get_format_data_structure(),"indexint[i]")
		);
		$format[] = $indexint;
