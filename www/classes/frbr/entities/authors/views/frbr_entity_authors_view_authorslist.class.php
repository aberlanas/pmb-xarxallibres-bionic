...
// +-------------------------------------------------+
// $Id: frbr_entity_authors_view_authorslist.class.php,v 1.2 2017-04-20 17:14:28 dgoron Exp $
...
{% endfor %}
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $author){
				$auteur = new auteur($author);
				$infos= $auteur->format_datas();
				$render_datas['authors'][]=$infos;
			}
		}
		//on rappelle le tout...
	...
	public function get_format_data_structure(){		
		...
		$works = array(
			...
			'children' => $this->prefix_var_tree(auteur::get_format_data_structure(),"authors[i]")
		);
		$format[] = $works;
