...
// +-------------------------------------------------+
// $Id: rent_accounts.class.php,v 1.25.2.1 2017-12-11 09:23:13 dgoron Exp $
...
class rent_accounts extends rent_root {
	...
	public function get_display_content_list() {
		...
		foreach ($this->objects as $account) {
			...
			$display .= '<td align="center" id="icon_'.$account->get_id().'">'.$account->get_state_invoice().'</td>';
			$display .= '</tr>';
		}
		return $display;
	}
	...
	public function get_display_header_list() {
		...
		$display = "
		<tr>
			<th width='5px'><input type='checkbox' id='accounts_select_all' value='1' onchange='accounts_select();' title=\"".$msg['acquisition_accounts_select_unselect']."\" /></th>
