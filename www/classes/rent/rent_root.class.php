...
// +-------------------------------------------------+
// $Id: rent_root.class.php,v 1.6 2017-07-12 15:15:01 tsamson Exp $
...
class rent_root {
	...
	protected function pager() {
		...
		if($precedente > 0) {
			$nav_bar .= "<a href='#' onClick=\"document.".$this->objects_type."_search_form.".$this->objects_type."_page.value=".$precedente."; document.".$this->objects_type."_search_form.submit(); return false;\"><img src='./images/left.gif' border='0'  title='$msg[48]' alt='[$msg[48]]' hspace='3' align='middle'></a>";
		}
		...
		if($suivante <= $this->pager['nb_page']) {
			$nav_bar .= "<a href='#' onClick=\"document.".$this->objects_type."_search_form.".$this->objects_type."_page.value=".$suivante."; document.".$this->objects_type."_search_form.submit(); return false;\"><img src='./images/right.gif' border='0' title='$msg[49]' alt='[$msg[49]]' hspace='3' align='middle'></a>";
		}
