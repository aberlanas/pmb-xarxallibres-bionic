...
// +-------------------------------------------------+
// $Id: list_transferts_reception_ui.class.php,v 1.2 2017-03-02 13:13:00 dgoron Exp $
...
class list_transferts_reception_ui extends list_transferts_ui {
	...
	protected function init_default_columns() {
		...
		if($action == '' && $transferts_reception_lot == '1') {
	...
	protected function get_action_buttons() {
		...
		global $transferts_reception_lot;
		if ($transferts_reception_lot=="1") {
			return "<input type='button' class='bouton' name='".$msg["transferts_circ_btReception"]."' value='".$msg["transferts_circ_btReception"]."' onclick='verifChk(document.form_circ_".$this->objects_type.",\"aff_recep\")'>";
		} else {
			return "";
		}
	}
