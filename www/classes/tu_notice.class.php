...
// +-------------------------------------------------+
// $Id: tu_notice.class.php,v 1.36.2.2 2017-11-21 15:29:52 jpermanne Exp $
...
class tu_notice {
	...
	public static function gen_input_selection($label,$form_name,$item,$values,$what_sel,$class='saisie-80em' ) {  
		...
		function fonction_selecteur_".$item."() {
			...
			if(indice == 0){
			openPopUp('./select.php?what=$what_sel&caller=$form_name&param1='+name_id+'&param2='+name+'&callback=tu_add_callback&deb_rech='+document.getElementById(nom+indice).value, '$what_sel', 400, 400, -2, -2, '$select_prop');	        
			}else{
			 openPopUp('./select.php?what=$what_sel&caller=$form_name&param1='+name_id+'&param2='+name+'&deb_rech='+document.getElementById(nom+indice).value, '$what_sel', 400, 400, -2, -2, '$select_prop');
	        }	        
	    }
...
// 		if($first_one->tu->get_object_instance()->oeuvre_nature)
	} 
