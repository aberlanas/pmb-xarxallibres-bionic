...
// +-------------------------------------------------+
// $Id: sel_oeuvre_event.tpl.php,v 1.2 2017-01-19 10:25:18 dgoron Exp $
...
<script type='text/javascript'>
	function set_parent(f_caller, id_value, libelle_value, callback){	
		...
		if (flag) {
			for (i=0; i<n_auth; i++) {
				if ((w.opener.document.getElementById('".$field_id."'+i).value==0)||(w.opener.document.getElementById('".$field_id."'+i).value=='')||(w.opener.document.getElementById('".$field_id."'+i).value=='0')){
					break;
				}	
			}
			if (i==n_auth) w.opener.".$add_field."();
