...
// +-------------------------------------------------+
// $Id: sel_commande.tpl.php,v 1.2 2017-01-19 10:25:19 dgoron Exp $
...
function set_parent(id_value, libelle_value, callback)
{
	...
	if (callback) {
		window.opener[callback](id_value);
	}
	window.close();
}
-->
