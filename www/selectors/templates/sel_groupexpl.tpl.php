...
// +-------------------------------------------------+
// $Id: sel_groupexpl.tpl.php,v 1.3 2017-01-19 10:25:19 dgoron Exp $
...
function set_parent(dom_id, id_value, libelle_value){console.log(dom_id,id_value);
	if(window.opener.document.getElementById(dom_id)) {
		window.opener.document.getElementById(dom_id).innerHTML = reverse_html_entities(libelle_value);
