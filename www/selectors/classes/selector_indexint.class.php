...
// +-------------------------------------------------+
// $Id: selector_indexint.class.php,v 1.4 2017-06-30 09:43:08 apetithomme Exp $
...
class selector_indexint extends selector_authorities {
	...
	protected function get_form() {
		...
		$indexint_form = str_replace("!!deb_saisie!!", htmlentities($this->user_input,ENT_QUOTES,$charset), $indexint_form);
		$indexint_form = str_replace("!!base_url!!",static::get_base_url(),$indexint_form);
		return $indexint_form;
	}
	...
	protected function get_display_object($authority_id=0, $object_id=0) {
		...
		$display = '';
		$authority = new authority($authority_id, $object_id, AUT_TABLE_INDEXINT);
