...
// +-------------------------------------------------+
// $Id: selector_publisher.class.php,v 1.3 2017-06-30 09:43:08 apetithomme Exp $
...
class selector_publisher extends selector_authorities {
	...
	protected function get_form() {
		...
		$publisher_form = str_replace("!!deb_saisie!!", htmlentities($this->user_input,ENT_QUOTES,$charset), $publisher_form);
		$publisher_form = str_replace("!!base_url!!",static::get_base_url(),$publisher_form);
	...
	protected function get_display_object($authority_id=0, $object_id=0) {
		...
		$display = '';
		$authority = new authority($authority_id, $object_id, AUT_TABLE_PUBLISHERS);
