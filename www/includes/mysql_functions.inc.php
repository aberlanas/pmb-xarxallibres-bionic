...
// +-------------------------------------------------+
// $Id: mysql_functions.inc.php,v 1.3 2017-07-10 13:01:34 tsamson Exp $

define("PMB_MYSQL_ASSOC", MYSQL_ASSOC);
define("PMB_MYSQL_BOTH", MYSQL_BOTH);
define("PMB_MYSQL_NUM", MYSQL_NUM);
