...
// +-------------------------------------------------+
// $Id: dynamic_search.class.php,v 1.3 2016-05-10 12:02:22 dgoron Exp $
    		...
    		case 'authorities' :
    			switch($this->prefix) {
    				...
    				case 'categ' :
    					...
    					break;
    				case 'publisher' :
    					$join_query .= " join publishers on publishers.ed_id=authorities.num_object and authorities.type_object = 3 join publisher_custom_values on publisher_custom_origine=publisher_id ";
    					break;
    				case 'collection' :
