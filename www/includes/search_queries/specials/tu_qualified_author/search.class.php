...
// +-------------------------------------------------+
// $Id: search.class.php,v 1.7.2.1 2018-02-01 16:40:33 plmrozowski Exp $
...
// 			        element.appendChild(f_aut);
    ...
    public function make_search() {
    	...
    	if (!$this->is_empty($values)) {
	    	...
	    	pmb_mysql_query("create temporary table t_s_tu_qualified_author (id_authority integer unsigned not null) as ".$query);
	 		pmb_mysql_query("alter table t_s_tu_qualified_author add primary key(id_authority)");
    	}
