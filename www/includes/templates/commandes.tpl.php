...
// +-------------------------------------------------+
// $Id: commandes.tpl.php,v 1.69 2017-02-02 08:37:28 jpermanne Exp $
...
function act_line_action(type_action) {
	...
	if (checked_lines) {
		if (type_action == 'transfer') {
			openPopUp('select.php?what=commande&callback=act_transfer_checked_lines&id_cmd=!!id_cde!!', 'select_commande', 600, 400, -2, -2, 'infobar=no, status=no, scrollbars=yes, toolbar=no, menubar=no, dependent=yes, resizable=yes');
		} else if (type_action == 'duplicate') {
			openPopUp('select.php?what=commande&callback=act_duplicate_checked_lines&id_cmd=!!id_cde!!', 'select_commande', 600, 400, -2, -2, 'infobar=no, status=no, scrollbars=yes, toolbar=no, menubar=no, dependent=yes, resizable=yes');
		}
	} else {
...
<tr id='C_!!no!!_Child' class='act_cell_comments' style='display:none;'>
	<td colspan='9'>
		<table>
			<tr>
				<td width='10%' >".htmlentities($msg['acquisition_comment_lg'],ENT_QUOTES,$charset)."</td>
				<td width='40%'>
					<textarea id='comment_lg[!!no!!]' name='comment_lg[!!no!!]' tabindex='1' class='in_cell' rows='1' wrap='virtual'>!!comment_lg!!</textarea>
				</td>
				<td width='10%'>".htmlentities($msg['acquisition_comment_lo'],ENT_QUOTES,$charset)."</td>
				<td width='40%'>
...
$first_applicant_line = "<div class='row'>
							...
							<input class='bouton' type='button' value='...' title='".htmlentities($msg['grp_liste'],ENT_QUOTES,$charset)."' onclick='openPopUp(\"./select.php?what=emprunteur&caller=act_modif&param1=C_!!no!!_applicants_0&param2=C_!!no!!_empr_label_0\", \"C_!!no!!_applicants_0\", 400, 400, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")'>
...
$others_applicants_line = "<div class='row'>
							...
							<input class='bouton' type='button' value='...' title='".htmlentities($msg['grp_liste'],ENT_QUOTES,$charset)."' onclick='openPopUp(\"./select.php?what=emprunteur&caller=act_modif\", \"C_!!no!!_applicants_!!nb!!\",, 400, 400, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")'>
