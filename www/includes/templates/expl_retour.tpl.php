...
// +-------------------------------------------------+
// $Id: expl_retour.tpl.php,v 1.15.2.1 2017-12-15 09:04:00 ngantier Exp $
...
$rfid_js_header
	...
	<form class='form-$current_module' name='saisie_cb_ex' method='post' action='!!form_action!!' onSubmit=\"return f_submit_rfid(this);\">	
		...
		<div class='row'>
			...
			&nbsp;&nbsp;
			<input type='submit' class='bouton' value='$msg[502]' />&nbsp;<img src='./images/sauv_succeed.png' id='indicateur' class='align_top' ><span class='erreur' id='indicateur_nb_doc'></span>
		</div>
		<!--memo_cb_rfid_form-->
	</form>
	<script type='text/javascript'>
