...
// +-------------------------------------------------+
// $Id: notice_relations.tpl.php,v 1.6.2.1 2018-02-09 16:01:40 dgoron Exp $
			...
			<div class='colonne2'>
				...
				<div id='el11Child_0d' class='row'>
					<input type='text' class='saisie-30emr' id='f_rel_!!n_rel!!' name='f_rel_!!n_rel!!' data-form-name='f_rel_' value=\"!!notice_relations_libelle!!\" completion=\"notice\" autfield=\"f_rel_id_!!n_rel!!\" autexclude=\"!!notice_id_no_replace!!\" !!linked_notice_is_disabled!! />
		   		    <input type='button' class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=notice&caller=notice&param1=f_rel_id_!!n_rel!!&param2=f_rel_!!n_rel!!&no_display=!!notice_id_no_replace!!', 'select_notice', 700, 500, -2, -2, '')\" !!linked_notice_button_is_hidden!! />
