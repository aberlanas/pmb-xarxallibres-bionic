...
// +-------------------------------------------------+
// $Id: cms_build.tpl.php,v 1.78.2.2 2017-12-21 08:53:14 ngantier Exp $
...
<div id='cms_build_navig_informations'>
	...
	<span id='add_buttons_clear cache_img' class='cache liLike'>
		".'<div data-dojo-type=\'dijit/form/Button\' data-dojo-props=\'id:"clean_cache_button_img",onclick:"if(confirm(\"'.$msg['cms_clean_cache_confirm_img'].'\")){document.location=\"'.$base_path.'/cms.php?categ=build&sub=block&action=clean_cache_img\";}"\'>'.$msg['cms_clean_cache_img'].'</div>'."				
	</span>
</div>
