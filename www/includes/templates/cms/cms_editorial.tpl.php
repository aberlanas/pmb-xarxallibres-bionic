...
// +-------------------------------------------------+
// $Id: cms_editorial.tpl.php,v 1.34.2.1 2017-12-15 14:19:30 dgoron Exp $
...
$cms_editorial_form_tpl = "
	<form name='!!cms_editorial_form_name!!' class='cms_editorial_form' action='./cms.php?categ=!!type!!&sub=save' id='!!cms_editorial_form_id!!' method='post' !!cms_editorial_form_attr!!>
		...
		<div class='form-contenu'>
			...
			<div class='row'>&nbsp;</div>
			<hr>
			<div id='editorial_type_content_form' dojoType='apps/cms/CmsEditorialTypeContentForm' href='!!type_href!!' data-dojo-props='data:{type : \"!!type!!\"}'></div>
		</div>
		<div class='row'>
			<div class='left'>
...
$cms_editorial_permalink_field = "<div class='row'>
