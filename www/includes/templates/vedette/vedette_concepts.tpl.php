...
// +-------------------------------------------------+
// $Id: vedette_concepts.tpl.php,v 1.7 2017-06-15 09:29:54 apetithomme Exp $
...
var vedette_concepts = {
	...
	callback : function(id) {
		...
		document.getElementById(id).value = document.getElementById(id).value.substr(scheme_length+2);
