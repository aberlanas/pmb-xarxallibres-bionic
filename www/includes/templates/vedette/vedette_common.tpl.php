...
// +-------------------------------------------------+
// $Id: vedette_common.tpl.php,v 1.8 2016-05-17 13:00:09 vtouchard Exp $
...
<script type="text/javascript">
	...
	var vedette_element =  {
		...
		create_box : function(caller_property_name,vedette_type, parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel, vedette_composee_order, authid) {
			var vedette_element = this.get_vedette_element(vedette_type);
			vedette_element.create_box(caller_property_name,parent, vedette_composee_subdivision_id, vedette_composee_element_order, id, label, rawlabel, vedette_composee_order, authid);
		},
