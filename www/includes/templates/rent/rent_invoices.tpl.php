...
// +-------------------------------------------------+
// $Id: rent_invoices.tpl.php,v 1.9 2017-07-12 13:41:04 arenou Exp $
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=editeur&caller=invoices_search_form&p1=invoices_search_form_num_publisher&p2=invoices_search_form_publisher&deb_rech='+this.form.invoices_search_form_publisher.value, 'select_publisher', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
