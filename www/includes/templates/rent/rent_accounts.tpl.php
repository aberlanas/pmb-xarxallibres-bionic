...
// +-------------------------------------------------+
// $Id: rent_accounts.tpl.php,v 1.14 2017-07-12 13:40:17 arenou Exp $
	...
	<div class='form-contenu'>
		...
		<div class='row'>
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=editeur&caller=accounts_search_form&p1=accounts_search_form_num_publisher&p2=accounts_search_form_publisher&deb_rech='+this.form.accounts_search_form_publisher.value, 'select_publisher', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
			...
			<div class='colonne3'>
				...
				<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=auteur&caller=accounts_search_form&param1=accounts_search_form_num_author&param2=accounts_search_form_author&deb_rech='+this.form.accounts_search_form_author.value, 'select_author', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
