...
// +-------------------------------------------------+
// $Id: rent_account.tpl.php,v 1.21.2.1 2017-12-06 09:42:40 dgoron Exp $
...
<div class='form-contenu'>
	...
	<div id='el_account_uniform_title' class='row'>
		...
		<div class='row'>
			...
			<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=titre_uniforme&caller=account_form&callback=tu_account_mapper_callback&param1=account_num_uniform_title&param2=account_uniform_title&deb_rech='+encodeURIComponent(this.form.account_uniform_title.value), 'select_uniform_title', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
	...
	<div id='el_account_publisher' class='row'>
		...
		<div class='row'>
			...
			<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=editeur&caller=account_form&p1=account_num_publisher&p2=account_publisher&callback=account_maj_supplier_field&deb_rech='+this.form.account_publisher.value, 'select_publisher', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
	...
	<div id='el_account_supplier' class='row'>
		...
		<div class='row'>
			...
			<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=fournisseur&caller=account_form&param1=account_num_supplier&param2=account_supplier&id_bibli=!!entity_id!!&deb_rech='+this.form.account_supplier.value, 'select_supplier', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
	...
	<div id='el_account_author' class='row'>
		...
		<div class='row'>
			...
			<input type='button' class='bouton_small' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=auteur&caller=account_form&param1=account_num_author&param2=account_author&deb_rech='+this.form.account_author.value, 'select_author', 500, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')\"/>
