...
// +-------------------------------------------------+
// $Id: rent_pricing_systems.tpl.php,v 1.2 2016-02-18 10:42:22 dgoron Exp $
...
<tr class='!!odd_even!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!odd_even!!'\">
	<td>
		<img class='img_plus' id='pricing_system_img_!!id!!' onclick='display_grid(!!id!!);' src='./images/plus.gif' />
	</td>
