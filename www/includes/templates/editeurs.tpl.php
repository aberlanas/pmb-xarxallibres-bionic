...
// +-------------------------------------------------+
// $Id: editeurs.tpl.php,v 1.41.2.1 2017-11-23 14:09:17 wlair Exp $
	...
	<div id='zone-container'>
        ...
        <div id='el0Child_7' movable='yes' class='row' title=\"".htmlentities($msg['acquisition_ach_fou2'], ENT_QUOTES, $charset)."\">
			...
			<div class='row'>
				...
				<input type='button' class='bouton' tabindex='1' value='".$msg['parcourir']."' onclick=\"openPopUp('./select.php?what=fournisseur&caller=saisie_editeur&param1=id_fou&param2=lib_fou&param3=adr_fou&id_bibli=&deb_rech='+".pmb_escape()."(this.form.lib_fou.value), 'select_fournisseur', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes'); \" />
