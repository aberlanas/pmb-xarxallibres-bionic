...
// +-------------------------------------------------+
// $Id: transferts.tpl.php,v 1.30.2.1 2017-08-22 08:14:06 jpermanne Exp $
...
$transferts_popup_table_expl_fantomes = "
		<div class='row' id='virtual_ex_div' >
			<table style='display:none' border='0' id='ghost_table' class='sortable'>		
				<tr>
					<th align='left'>".$msg["transfert_ghost_expl_from"]."</th>
					<th align='left'>".$msg[293]."</th>
					<th align='left'>".$msg[296]."</th>
					<th align='left'>".$msg["extexpl_statut"]."</th>
					<th align='left'>".$msg["groupexpl_form_comment"]."</th> 
				</tr>
...
$transfert_popup_ligne_groupe_tableau = "
		<th align='left'>!!group_libelle!!</th>
		<th align='left' colspan='5'>!!group_expl_checkbox!!</th>
		";
...
$transferts_validation_tableau_definition = "
		...
		<tr>
			...
			<th align='left'>".$msg["transferts_edition_ask_user"]."</th>
			<th align='left'>".$msg["transferts_edition_send_user"]."</th>
