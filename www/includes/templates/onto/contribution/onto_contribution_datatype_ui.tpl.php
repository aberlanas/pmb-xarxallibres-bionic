...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_ui.tpl.php,v 1.2.2.1 2017-12-27 09:47:01 apetithomme Exp $
...
<input type="button" class="bouton_small" onclick="onto_open_selector(\'!!onto_row_id!!\', \'!!onto_selector_url!!\');" value="'.$msg['ontology_p_sel_button'].'" id="!!onto_row_id!!_sel" />
';
