...
// +-------------------------------------------------+
// $Id: onto_skos_concept_ui.tpl.php,v 1.17.2.1 2017-10-04 13:00:11 ngantier Exp $
...
<form action="!!skos_concept_search_form_action!!" method="post" name="search" class="form-autorites" onsubmit="check_submit();">
	...
	<div class="row">
		...
		<div class="right">
			<a href="!!skos_concept_search_form_last_concepts_link!!">'.$msg['onto_skos_show_last_concepts'].'</a>
		</div>		
		<div class="row"> </div>			
	</div>
</form>
