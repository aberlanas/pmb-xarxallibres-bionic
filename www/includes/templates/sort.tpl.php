...
// +-------------------------------------------------+
// $Id: sort.tpl.php,v 1.12 2017-05-18 11:02:07 dgoron Exp $
...
$ligne_tableau_tris = "
						<tr class='!!pair_impair!!' onmouseover=\"this.className='surbrillance'\" onmouseout=\"this.className='!!pair_impair!!'\" style='cursor: pointer'>
							<td width='90%' alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."' onClick='parent.document.getElementById(\"history\").style.display=\"none\";parent.location.href=\"./recall.php?current=" . (isset($_SESSION["CURRENT"]) ? $_SESSION["CURRENT"] : '') . "&t=NOTI&tri=!!id_tri!!\"; return false;'>
									!!nom_tri!!
							</td>
							<td width='5%'>
