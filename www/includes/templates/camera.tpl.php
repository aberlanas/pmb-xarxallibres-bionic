...
// +-------------------------------------------------+
// $Id: camera.tpl.php,v 1.1 2016-08-19 12:36:41 ngantier Exp $
...
(function() {		
	...
	function savepicture() {	
		...
		xhr_object.request("./camera_upload.php",true,"imgBase64=" + dataUrl + "&upload_filename=" + init_camera_filename, true, cback, 0, 0);	
	}
...
function init_camera(filename, field, replace_part) {
	if (init_camera_filename){
...
require(["dojo/dom", "dojo/domReady!"], function(dom){
	...
	function savepicture() {			
		...
		var dataUrl_encode = encodeURIComponent(dataUrl);
	 	var xhr_object = new http_request();					
		xhr_object.request("./camera_upload.php",true,"imgBase64=" + dataUrl_encode + "&upload_filename=" + init_camera_filename, true, cback, 0, 0);
	}
