...
// +-------------------------------------------------+
// $Id: collstate.tpl.php,v 1.14 2017-01-30 14:09:09 dgoron Exp $
...
<div id='collstate_advanced_expl_listParent' class='notice-parent'>
	<img src='./images/plus.gif' class='img_plus' name='imEx' id='collstate_advanced_expl_list"."Img' title='".$msg['plus_detail']."' border='0' onClick=\"expandBase('collstate_advanced_expl_list', true); return false;\" hspace='3'>
