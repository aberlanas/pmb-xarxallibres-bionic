...
// +-------------------------------------------------+
// $Id: contribution_area_equation.tpl.php,v 1.1.2.1 2017-07-28 14:34:32 vtouchard Exp $
...
function confirm_delete() {
    ...
    if(result) {
        unload_off();
        document.location='./admin.php?categ=contribution_area&sub=equation&action=delete&id=!!id!!';
	} else
...
<form class='form-$current_module' name='contribution_area_equation_form' method='post' action='./admin.php?categ=contribution_area&sub=equation&action=save'>
	<h3>!!libelle!!</h3>
