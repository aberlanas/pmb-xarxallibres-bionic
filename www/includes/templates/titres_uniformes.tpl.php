...
// +-------------------------------------------------+
// $Id: titres_uniformes.tpl.php,v 1.65.2.1 2017-11-23 14:09:17 wlair Exp $

if (stristr($_SERVER['REQUEST_URI'], ".tpl.php")) die("no access");

if(!isset($pmb_authors_qualification)) $pmb_authors_qualification = '';
if(!isset($pmb_autorites_verif_js)) $pmb_autorites_verif_js = '';
if(!isset($value_deflt_fonction)) $value_deflt_fonction = '';
	...
	<div id='zone-container'>
		...
		<div id='el0Child_7' class='row' movable='yes' title=\"".htmlentities($msg["aut_oeuvre_form_forme_list"], ENT_QUOTES, $charset)."\">
			...
			<div class='row'>
	            ...
	            <input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=music_form&caller=saisie_titre_uniforme&p1=form_form_selector&p2=music_form&deb_rech='+".pmb_escape()."(this.form.music_form.value), 'select_tonalite', 500, 400, -2, -2, '$selector_prop')\" />
		...
		<div id='el0Child_18' class='row' movable='yes' title=\"".htmlentities($msg["aut_titre_uniforme_form_tonalite_list"], ENT_QUOTES, $charset)."\">
			...
			<div class='row'>
	            ...
	            <input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=music_key&caller=saisie_titre_uniforme&p1=form_tonalite_selector&p2=music_key&deb_rech='+".pmb_escape()."(this.form.music_key.value), 'select_tonalite', 500, 400, -2, -2, '$selector_prop')\" />
...
function fonction_selecteur_oeuvre_expression() {
	...
	openPopUp('./select.php?what=titre_uniforme&caller=saisie_titre_uniforme&param1='+name_id+'&param2='+name, 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop');
}
...
<input type='button' class='bouton' value='$msg[parcourir]' 
	onclick=\"openPopUp('./select.php?what=titre_uniforme&caller=saisie_titre_uniforme&field_id=f_oeuvre_expression_code&field_name_id=f_oeuvre_expression&dyn=3&max_field=max_oeuvre_expression&add_field=add_oeuvre_expression&callback=formMapperCallback', 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop')\" />
...
<input type='button' class='bouton' value='$msg[parcourir]' 
	onclick=\"openPopUp('./select.php?what=titre_uniforme&caller=saisie_titre_uniforme&field_id=f_other_link_code&field_name_id=f_other_link&dyn=3&max_field=max_other_link&add_field=add_other_link&myid=!!myid!!', 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop')\" />
...
<div style='float:left;margin-right:10px;'>
	...
	<div class='row'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=auteur&caller=saisie_titre_uniforme&param1=f_aut!!n!!_id!!iaut!!&param2=f_aut!!n!!!!iaut!!&deb_rech='+".pmb_escape()."(this.form.f_aut!!n!!!!iaut!!.value), 'select_author2', 500, 400, -2, -2, '$selector_prop')\" />
...
<div style='float:left'>
	...
	<div class='row'>
		...
		<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=function&caller=saisie_titre_uniforme&p1=f_f!!n!!_code!!iaut!!&p2=f_f!!n!!!!iaut!!', 'select_func2', 500, 400, -2, -2, '$selector_prop')\" />
...
<input type='button' class='bouton' value='".$msg['parcourir']."' 
	onclick=\"openPopUp('./select.php?what=oeuvre_event&caller=saisie_titre_uniforme&field_id=f_oeuvre_event_code&field_name_id=f_oeuvre_event&dyn=3&max_field=max_oeuvre_event&add_field=add_oeuvre_event&myid=!!myid!!', 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop')\" />
...
<input type='button' class='bouton' value='$msg[parcourir]' 
	onclick=\"openPopUp('./select.php?what=titre_uniforme&caller=saisie_titre_uniforme&field_id=f_oeuvre_expression_from_code&field_name_id=f_oeuvre_expression_from&dyn=3&max_field=max_oeuvre_expression_from&add_field=add_oeuvre_expression_from&callback=formMapperCallback', 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop')\" />
...
function fonction_selecteur_tu_notices() {
	var name=this.getAttribute('id').substring(4);
	var name_id = name.substr(0,14)+'_code'+name.substr(14);
	openPopUp('./select.php?what=notice&caller=saisie_titre_uniforme&param1='+name_id+'&param2='+name, 'select_titre_uniforme', 500, 400, -2, -2, '".$selector_prop."');
}
...
<input type='button' class='bouton' value='".$msg['parcourir']."'
onclick=\"openPopUp('./select.php?what=notice&caller=saisie_titre_uniforme&field_id=f_tu_notices_code&field_name_id=f_tu_notices&dyn=3&max_field=max_tu_notices&add_field=add_tu_notices&myid=!!myid!!', 'select_titre_uniforme', 500, 400, -2, -2, '$selector_prop')\" />
