...
// +-------------------------------------------------+
// $Id: avis.tpl.php,v 1.15 2017-05-05 09:12:15 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], "tpl.php")) die("no access");

if(!isset($id)) $id = 0;
if(!isset($pmb_avis_note_display_mode)) $pmb_avis_note_display_mode = 0;
if(!isset($pmb_javascript_office_editor)) $pmb_javascript_office_editor = '';
