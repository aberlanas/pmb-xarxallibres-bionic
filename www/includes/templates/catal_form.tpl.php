...
// +-------------------------------------------------+
// $Id: catal_form.tpl.php,v 1.168.2.2 2017-11-23 09:24:24 dgoron Exp $
...
if($pmb_authors_qualification){
	$authors_qualification_tpl="
	        ...
	        <div  id='el1Child_2a_vedettes' style='float:left;'>
				...
				<div class='row'>
					<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette0'); return false;\" title='détail' name='imEx' src='./images/plus.gif'>
...
if($pmb_authors_qualification){
	...
	$authors_qualification_tpl="
        ...
        <div style='float:left;'>
			<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette!!iaut!!_autre'); return false;\" title='détail' name='imEx' src='./images/plus.gif'>
...
if($pmb_authors_qualification){
	...
	$authors_qualification_tpl="
        <!--    Vedettes    -->
        <div style='float:left;'>
			<img class='img_plus' hspace='3' border='0' onclick=\"expand_vedette(this,'vedette!!iaut!!_secondaire'); return false;\" title='détail' name='imEx' src='./images/plus.gif'>
