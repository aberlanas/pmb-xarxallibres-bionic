...
// +-------------------------------------------------+
// $Id: nomenclature_material_admin.tpl.php,v 1.1 2016-03-30 13:13:27 apetithomme Exp $
...
<form class='form-".$current_module."' id='nomenclature_material_form' name='nomenclature_material_form'  method='post' action=\"admin.php?categ=material&sub=material&action=save\" >
	<div class='form-contenu'>
		...
		<div class='row'>
			...
			<input class='bouton' type='button' onclick='openPopUp(\"select.php?what=ontology&caller=nomenclature_material_form&param1=music_concept_before_value&param2=music_concept_before&element=concept\", \"select_concept\", 700, 500, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")' value='...'>
		...
		<div class='row'>
			...
			<input class='bouton' type='button' onclick='openPopUp(\"select.php?what=ontology&caller=nomenclature_material_form&param1=music_concept_after_value&param2=music_concept_after&element=concept\", \"select_concept\", 700, 500, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")' value='...'>
		...
		<div class='row'>
			...
			<input class='bouton' type='button' onclick='openPopUp(\"select.php?what=ontology&caller=nomenclature_material_form&param1=music_concept_blank_value&param2=music_concept_blank&element=concept\", \"select_concept\", 700, 500, -2, -2, \"scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\")' value='...'>
