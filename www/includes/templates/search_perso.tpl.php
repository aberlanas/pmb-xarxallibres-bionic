...
// +-------------------------------------------------+
// $Id: search_perso.tpl.php,v 1.7.2.1 2017-08-22 09:20:30 jpermanne Exp $
...
<tr id='search_perso_!!id!!' class='!!pair_impair!!' !!tr_surbrillance!! style='cursor: pointer' dragtype='search_perso' draggable='yes' recept='yes' recepttype='search_perso' 
	handler='search_perso_!!id!!_handle' dragicon=\"".$base_path."/images/icone_drag_notice.png\" downlight='search_perso_downlight' highlight='search_perso_downlight'>
	<td id='search_perso_!!id!!_handle' style=\"float:left; padding-right : 7px\"><img src=\"".$base_path."/images/sort.png\" style='width:12px; vertical-align:middle' /></td>
