...
<script type='text/javascript'>
	...
	function confirm_delete() {
	    if(confirm('!!name_del_facette!!')) {
	        document.location='./admin.php?categ=opac&sub=facette_search_opac&section=!!section!!&action=delete&id=!!id!!';
		}
	}
	
	function load_subfields(id_ss_champs){
		var xhr_object=  new http_request();					
		xhr_object.request('./ajax.php?module=admin&categ=opac&section=lst_!!section!!',true,\"list_crit=\"+document.getElementById('list_crit').value+\"&sub_field=\"+id_ss_champs,'true',cback,0,0)
	}
...
<form class='form-$current_module' name='facette_form' method='post' action='./admin.php?categ=opac&sub=facette_search_opac&section=!!section!!&action=save&id=!!id!!' onSubmit='return check_form_facette()'>
	<h3>!!libelle!!</h3>
...
$tpl_form_facette .= "</br />
	...
	<div class='left'>
		...
		<input class='bouton' type='button' value='".htmlentities($msg['submitStopFacette'],ENT_QUOTES,$charset)."' onClick=\"document.location='./admin.php?categ=opac&sub=facette_search_opac&section=!!section!!'\"/>
	</div>
	<div class='right'>
			!!val_submit_suppr!!
	</div>
