...
// +-------------------------------------------------+
// $Id: scan_request.tpl.php,v 1.23 2017-05-18 11:02:07 dgoron Exp $
		...
		<div class="row">
			<div class="colonne3">
				...
				<div class="row">
					...
					<input class="bouton" type="button" onclick="openPopUp(\'./select.php?what=emprunteur&caller=scan_request_form&param1=scan_request_num_dest_empr&param2=scan_request_lib_dest_empr&auto_submit=NO\', \'select_empr\', 400, 400, -2, -2, \'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\')" value="...">
...
<div class="row">
	<label>'.$msg["scan_request_form_associated_buls"].'</label>
	<a href="javascript:expandAll(document.getElementById(\'bul_container\'))"><img src="./images/expand_all.gif" id="expandall" border="0"></a>
	<a href="javascript:collapseAll(document.getElementById(\'bul_container\'))"><img src="./images/collapse_all.gif" id="collapseall" border="0"></a>
</div>
<div id="bul_container">
...
<div class="row">
	<label>'.$msg["scan_request_form_associated_records"].'</label>
	<a href="javascript:expandAll(document.getElementById(\'record_container\'))"><img src="./images/expand_all.gif" id="expandall" border="0"></a>
	<a href="javascript:collapseAll(document.getElementById(\'record_container\'))"><img src="./images/collapse_all.gif" id="collapseall" border="0"></a>
</div>
<div id="record_container">
...
$scan_request_concept_part = '
		...
		<div class="row">
			...
			<input class="bouton" type="button" onclick="openPopUp(\'select.php?what=ontology&caller=scan_request_form&param1=scan_request_concept_uri_value&param2=scan_request_concept_uri&element=concept&grammar=music_explnum\', \'select_concept\', 700, 500, -2, -2, \'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes\')" value="...">
