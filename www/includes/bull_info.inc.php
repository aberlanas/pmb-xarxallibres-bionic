...
// +-------------------------------------------------+
// $Id: bull_info.inc.php,v 1.70 2017-06-27 12:16:57 jpermanne Exp $
...
//	
	...
	if(count($expl)){
		...
		if($pmb_pret_groupement || $pmb_transferts_actif) {
			if ($pmb_pret_groupement) $on_click_groupexpl = "if(check_if_checked(document.getElementById('expl_list_id').value,'groupexpl')) openPopUp('./select.php?what=groupexpl&caller=form_expl&expl_list_id='+get_expl_checked(document.getElementById('expl_list_id').value), 'select_groupexpl', 400, 400, -2, -2, 'scrollbars=yes, toolbar=no, dependent=yes, resizable=yes')";
