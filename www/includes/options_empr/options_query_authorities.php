...
// +-------------------------------------------------+
// $Id: options_query_authorities.php,v 1.6 2017-02-24 15:34:34 dgoron Exp $
...
// Création formulaire
	...
	foreach ($authpersos as $authperso){
		$options_authperso.="<option value='".($authperso['id'] + 1000)."' ".$data_type_selected[($authperso['id'] + 1000)]." >".$authperso['name']."</option>";
	}
