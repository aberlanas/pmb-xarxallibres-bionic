...
// +-------------------------------------------------+
// $Id: options_q_txt_i18n.php,v 1.3 2017-02-24 15:34:34 dgoron Exp $
...
<?php
	...
	?>">
		<input type="button" class="bouton" value="..." onclick="openPopUp('<?php echo $base_path; ?>/select.php?what=lang&caller=formulaire&p1=DEFAULT_LANG&p2=DEFAULT_LANG_LABEL', 'select_lang', 700, 500, -2, -2, 'toolbar=no, dependent=yes, resizable=yes, scrollbars=yes')" />
