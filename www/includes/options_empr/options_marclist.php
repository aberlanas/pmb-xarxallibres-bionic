...
// +-------------------------------------------------+
// $Id: options_marclist.php,v 1.4 2017-02-24 15:34:34 dgoron Exp $
...
// Création formulaire
	...
	<table class='table-no-border' width=100%>	
		...
		<table width=100% valign='center'>
			<tr><td><center>".ucfirst($msg['parperso_include_option_selectors_code'])."
			<br />
			<input type='radio' name='METHOD' value='1' ".$method_checked[1].">
			</center></td>
			<td><center>".ucfirst($msg['parperso_include_option_selectors_label'])."
			<br />
		...
		<table width=100% valign='center'>
			<tr><td><center>".ucfirst($msg['parperso_include_option_sort_selectors_code'])."
			<br />
			<input type='radio' name='METHOD_SORT_VALUE' value='1' ".$method_sort_value_checked[1].">
			</center></td>
			<td><center>".ucfirst($msg['parperso_include_option_sort_selectors_label'])."
			<br />
			<input type='radio' name='METHOD_SORT_VALUE' value='2' ".$method_sort_value_checked[2].">
			</center></td>
			<td><center>".ucfirst($msg['parperso_options_list_order'])."
			<br />
			<input type='radio' name='METHOD_SORT_VALUE' value='3' ".$method_sort_value_checked[3].">
			</center></td></tr>
			<tr><td><center>".ucfirst($msg['parperso_include_option_sort_selectors_asc'])."
			<br />
			<input type='radio' name='METHOD_SORT_ASC' value='1' ".$method_sort_asc_checked[1].">
			</center></td>
			<td><center>".ucfirst($msg['parperso_include_option_sort_selectors_desc'])."
			<br />
