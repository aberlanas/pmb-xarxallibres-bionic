...
// +-------------------------------------------------+
// $Id: lettre_commande.class.php,v 1.11 2017-02-17 15:34:01 dgoron Exp $
...
class lettreCommande_PDF {
	...
	public $text_titre = '';
	public $x_num = 10;				//Distance num commande / bord gauche de page
	public $y_num = 110;				//Distance num commande / bord haut de page
	public $l_num = 0;					//Largeur num commande
	public $h_num = 10;				//Hauteur num commande
	public $fs_num = 16;				//Taille police num commande
	public $text_num = '';				//Texte commande
	public $text_num_cli = '';
	public $text_ref = ''; 
	public $text_before = '';			//texte avant table commande
	public $text_after = '';			//texte après table commande
	public $h_tab = 5;					//Hauteur de ligne table commande
	public $fs_tab = 10;				//Taille police table commande
	public $x_tab = 10;				//position table commande / bord gauche page 
	public $y_tab = 10;				//position table commande / haut page sur pages 2 et + 
	...
	public function doLettre($id_bibli, $id_cde) {
		...
		$thresholds = new thresholds($bib->id_entite);
		if($acquisition_gestion_tva) {
	...
	public function getLettre($format=0,$name='commande.pdf') {
		if (!$format) {
