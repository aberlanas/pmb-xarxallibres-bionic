...
// +-------------------------------------------------+
// $Id: func_achats.inc.php,v 1.22.2.1 2017-09-20 15:10:36 mbertin Exp $
...
function getSessionDevState() {
	...
	if ((!isset($_SESSION['dev_statut']) || !$_SESSION['dev_statut']) && $deflt3dev_statut) {
...
function getSessionCdeState() {
	...
	if ((!isset($_SESSION['cde_statut']) || !$_SESSION['cde_statut']) && $deflt3cde_statut) {
...
function getSessionLivState() {
	...
	if ((!isset($_SESSION['liv_statut']) || !$_SESSION['liv_statut']) && $deflt3liv_statut) {
...
function getSessionFacState() {
	...
	if ((!isset($_SESSION['fac_statut']) || !$_SESSION['fac_statut']) && $deflt3fac_statut) {
