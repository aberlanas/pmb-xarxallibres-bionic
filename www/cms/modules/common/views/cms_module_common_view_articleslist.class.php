...
// +-------------------------------------------------+
// $Id: cms_module_common_view_articleslist.class.php,v 1.11 2016-08-12 13:52:00 vtouchard Exp $
		...
		if(is_array($datas)){
			foreach($datas as $article){
				...
				if($this->parameters['links']['article']['var'] && $this->parameters['links']['article']['page']){
					$article->set_var_name($this->parameters['links']['article']['var']);
					$article->set_num_page($this->parameters['links']['article']['page']);
				}
