...
// +-------------------------------------------------+
// $Id: cms_module_metadatas.class.php,v 1.5.4.2 2017-11-24 09:29:42 dgoron Exp $
	...
	protected function get_managed_metadatas_form($metadatas){
		...
		$form.="
			...
			<tr id='tr_metadata_!!item_key!!'>
				<td><img src='./images/b_edit.png' title=\"".$this->format_text($this->msg['cms_module_metadatas_group_edit_metadata'])."\" onclick=\"load_metadata_form('!!item_key!!');\" /></td>
