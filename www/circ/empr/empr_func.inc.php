...
// +-------------------------------------------------+
// $Id: empr_func.inc.php,v 1.90.2.2 2017-11-07 10:55:31 jpermanne Exp $
...
function show_empr_form($form_action, $form_cancel, $link, $id, $cb,$duplicate_empr_from_id="") {
	...
	global $camera_tpl, $empr_pics_folder, $deflt_camera_empr, $photo_tpl;
	global $base_path;
	...
	if($empr_pics_folder) {
		if($deflt_camera_empr) {
			...
			$empr_form = str_replace("!!camera!!", gen_plus('emr_camera', $msg['empr_photo_capture'], $camera_tpl, 0, "init_camera('" . $empr_pics_folder . "', 'f_cb', '!!num_carte!!');"), $empr_form);		
		} else {		
			$photo_tpl = str_replace("!!upload_folder!!", $empr_pics_folder, $photo_tpl);
			$empr_form = str_replace("!!camera!!", gen_plus('emr_camera', $msg['empr_photo_capture'], $photo_tpl, 0, "init_camera('" . $empr_pics_folder . "', 'f_cb', '!!num_carte!!');"), $empr_form);		
		}
	} else {
