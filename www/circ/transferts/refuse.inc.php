...
// +-------------------------------------------------+
// $Id: refuse.inc.php,v 1.11 2017-01-25 16:43:49 dgoron Exp $
	...
	case "aff_supp":
		...
		echo affiche_liste_valide(
				...
				"SELECT num_notice, num_bulletin, " .
					...
					"motif_refus as val_refusMotif, empr_cb as val_empr, transfert_ask_user_num, transfert_send_user_num " .
				"FROM transferts " .
