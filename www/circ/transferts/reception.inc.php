...
// +-------------------------------------------------+
// $Id: reception.inc.php,v 1.21 2017-02-28 11:43:13 dgoron Exp $

if (stristr($_SERVER['REQUEST_URI'], ".inc.php")) die("no access");

if(!isset($f_source)) $f_source = '';
	...
	case "aff_recep":
		...
		$tmpString =  affiche_liste_valide(
								...
								"SELECT num_notice, num_bulletin, id_transfert as val_id, " .
									...
									"expl_section as val_section, empr_cb as val_empr, transfert_ask_user_num, transfert_send_user_num " .
								"FROM transferts " .
...
if ($action=="") {
	...
	$tmpString = do_cb_expl($msg['transferts_circ_menu_titre']." > ".$msg['transferts_circ_menu_reception'],
								$msg[661], $msg['transferts_circ_reception_exemplaire'], "./circ.php?categ=trans&sub=".$sub."&f_source=".$f_source."&nb_per_page=".$nb_per_page, "recep");
	...
	echo affiche_liste(
		...
		"SELECT ".
			...
			"motif as val_motif, location_libelle as val_source, empr_cb as val_empr, transfert_ask_user_num, transfert_send_user_num " ,
		$req,
		$nb_per_page,
