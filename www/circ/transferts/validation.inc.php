...
// +-------------------------------------------------+
// $Id: validation.inc.php,v 1.12 2016-11-23 15:34:14 ngantier Exp $
...
if ($action == "") {
	...
	get_cb_expl($msg[transferts_circ_menu_titre]." > ".$msg[transferts_circ_menu_validation],
					$msg[661], $msg[transferts_circ_validation_exemplaire], "./circ.php?categ=trans&sub=".$sub."&f_destination=".$f_destination."&nb_per_page=".$nb_per_page);
