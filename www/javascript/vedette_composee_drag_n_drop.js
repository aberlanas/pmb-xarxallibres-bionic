...
// +-------------------------------------------------+
// $Id: vedette_composee_drag_n_drop.js,v 1.6 2016-05-17 13:00:09 vtouchard Exp $ */
...
function vedette_composee_available_fields_vedette_composee_subdivision(dragged,target){
	...
	/**
	 * Ci dessous: les trois globales à dégager
	 */
	...
	if ((dragged.getAttribute("parentorder") == target.getAttribute("parentorder")) && ((target.getAttribute("cardmax") == "") || (target.getAttribute("cardmax") > nb_elements))) {
		...
		vedette_element.create_box(caller_property_name,dragged.getAttribute("vedettetype"), div, target.getAttribute("subdivisiontype"), new_order, 0, "", "", target.getAttribute("parentorder"), dragged.getAttribute("authid"));
