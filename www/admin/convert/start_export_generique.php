...
// +-------------------------------------------------+
// $Id: start_export_generique.php,v 1.4.2.1 2017-11-17 09:41:43 wlair Exp $
...
echo "<table align=center width=100%><tr><td style=\"border-width:1px;border-style:solid;border-color:#FFFFFF;\" width=100%><div class='jauge'><img src=\"$base_path/images/jauge.png\" width=\"".$percent."%\" height=\"16\"></div></td></tr><tr><td ><center>".round($percent)."%</center></td></tr></table>\n";
