...
ALTER TABLE demandes_custom MODIFY name varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE demandes_custom MODIFY titre varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE demandes_custom MODIFY type varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'text';
ALTER TABLE demandes_custom MODIFY datatype varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE demandes_custom MODIFY options text CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE demandes_custom_lists MODIFY demandes_custom_list_value varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE demandes_custom_lists MODIFY demandes_custom_list_lib varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;

ALTER TABLE demandes_custom_values MODIFY demandes_custom_small_text varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE demandes_custom_values MODIFY demandes_custom_text text CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE pret_custom MODIFY name varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE pret_custom MODIFY titre varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE pret_custom MODIFY type varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT 'text';
ALTER TABLE pret_custom MODIFY datatype varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE pret_custom MODIFY options text CHARACTER SET utf8 COLLATE utf8_unicode_ci;

ALTER TABLE pret_custom_lists MODIFY pret_custom_list_value varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE pret_custom_lists MODIFY pret_custom_list_lib varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;

ALTER TABLE pret_custom_values MODIFY pret_custom_small_text varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL;
ALTER TABLE pret_custom_values MODIFY pret_custom_text text CHARACTER SET utf8 COLLATE utf8_unicode_ci;
...
ALTER TABLE shorturls MODIFY shorturl_hash varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE shorturls MODIFY shorturl_context text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL;
ALTER TABLE shorturls MODIFY shorturl_type varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
ALTER TABLE shorturls MODIFY shorturl_action varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '';
