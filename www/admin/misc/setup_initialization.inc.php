...
// +-------------------------------------------------+
// $Id: setup_initialization.inc.php,v 1.1 2015-12-03 16:20:29 dgoron Exp $
...
function pmb_indexation_display($title="", $message="") {
	...
	echo "<tr><td><font size='1'>".htmlentities($title, ENT_QUOTES, $charset)."</font></td><td><font size='1'>".htmlentities($message, ENT_QUOTES, $charset)."</font></td></tr>";
	flush();
	ob_flush();
}
