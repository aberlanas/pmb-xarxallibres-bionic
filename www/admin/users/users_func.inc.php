...
// +-------------------------------------------------+
// $Id: users_func.inc.php,v 1.44.2.1 2017-10-04 13:00:11 ngantier Exp $
...
function show_users($dbh) {
	...
	while(($row=pmb_mysql_fetch_object($res))) {
		...
		if($row->rights & ACQUISITION_ACCOUNT_INVOICE_AUTH)
			$dummy =str_replace('!!nuseracquisition_account_invoice!!', '<img src=./images/coche.gif align=top hspace=3>', $dummy);
		else
			$dummy =str_replace('!!nuseracquisition_account_invoice!!', '<img src=./images/uncoche.gif align=top hspace=3>', $dummy);	
		...
		if($row->rights & CMS_BUILD_AUTH)
			$dummy =str_replace('!!nusercms_build!!', '<img src=./images/coche.gif align=top hspace=3>', $dummy);
		else
			$dummy =str_replace('!!nusercms_build!!', '<img src=./images/uncoche.gif align=top hspace=3>', $dummy);
		...
		if($row->rights & CATAL_MODIF_CB_EXPL_AUTH)
			$dummy =str_replace('!!nusermodifcbexpl!!', '<img src=./images/coche.gif align=top hspace=3>', $dummy);	
		else 
			$dummy =str_replace('!!nusermodifcbexpl!!', '<img src=./images/uncoche.gif align=top hspace=3>', $dummy);

		if($row->rights & SEMANTIC_AUTH)
			$dummy =str_replace('!!nusersemantic!!', '<img src=./images/coche.gif align=top hspace=3>', $dummy);
		else
			$dummy =str_replace('!!nusersemantic!!', '<img src=./images/uncoche.gif align=top hspace=3>', $dummy);

		if($row->rights & CONCEPTS_AUTH)
			$dummy =str_replace('!!nuserconcepts!!', '<img src=./images/coche.gif align=top hspace=3>', $dummy);
		else
			$dummy =str_replace('!!nuserconcepts!!', '<img src=./images/uncoche.gif align=top hspace=3>', $dummy);
		...
		if($row->user_alert_resamail) {
			$user_alert_row = str_replace("!!user_alert!!", $msg['alert_resa_user_mail'].'<img src=./images/tick.gif align=top hspace=3>', $admin_user_alert_row);
		...
		if($row->user_alert_demandesmail) {
			$user_alert_row = str_replace("!!user_alert!!", $msg['alert_demandes_user_mail'].'<img src=./images/tick.gif align=top hspace=3>', $admin_user_alert_row);
		...
		if($row->user_alert_subscribemail) {
			$user_alert_row = str_replace("!!user_alert!!", $msg['alert_subscribe_user_mail'].'<img src=./images/tick.gif align=top hspace=3>', $admin_user_alert_row);
		...
		if($row->user_alert_suggmail) {
			$user_alert_row = str_replace("!!user_alert!!", $msg['alert_sugg_user_mail'].'<img src=./images/tick.gif align=top hspace=3>', $admin_user_alert_row);
		...
		if($row->user_alert_serialcircmail) {
			$user_alert_row = str_replace("!!user_alert!!", $msg['alert_subscribe_serialcirc_mail'].'<img src=./images/tick.gif align=top hspace=3>', $admin_user_alert_row);
