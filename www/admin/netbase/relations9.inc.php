...
// +-------------------------------------------------+
// $Id: relations9.inc.php,v 1.2 2017-06-07 12:27:03 dgoron Exp $
...
print "<br /><br /><h2 align='center'>".htmlentities($msg["nettoyage_update_relations"], ENT_QUOTES, $charset)."</h2>";
