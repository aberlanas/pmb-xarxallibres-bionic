...
// +-------------------------------------------------+
// $Id: gen_signature_docnum.inc.php,v 1.5 2017-06-22 12:20:02 apetithomme Exp $
...
print "<br /><br /><h2 align='center'>".htmlentities($msg["gen_signature_docnum"], ENT_QUOTES, $charset)."</h2>";
...
if(pmb_mysql_num_rows($result)) {
	...
	$v_state .= "<br /><img src='../../images/d.gif' hspace='3'>".htmlentities($msg["gen_signature_docnum_status"], ENT_QUOTES, $charset);
