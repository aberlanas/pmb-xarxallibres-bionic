...
// +-------------------------------------------------+
// $Id: statut.inc.php,v 1.24 2017-02-01 13:39:02 ngantier Exp $
...
function show_statut($dbh) {
	...
	for($i=0;$i<$nbr;$i++) {
		...
		if($pmb_transferts_actif) {
			if($row->transfert_flag) print "<td>".$msg["statut_allow_transfert_yes"]."</td>";
			else print "<td>".$msg["statut_allow_transfert_no"]."</td>";
		}	
