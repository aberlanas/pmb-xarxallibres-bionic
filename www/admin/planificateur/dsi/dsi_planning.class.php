...
// +-------------------------------------------------+
// $Id: dsi_planning.class.php,v 1.1.2.2 2017-10-20 08:21:35 plmrozowski Exp $
	...
	public function show_form ($param=array()) {
		...
		<div class='row'>
			...
			<div class='colonne60' >
				...
				<select id='list_bann' style='vertical-align:middle' class='saisie-85' name='list_bann[]' size='".$size_select."' multiple>";
