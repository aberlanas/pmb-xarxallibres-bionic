...
// +-------------------------------------------------+
// $Id: statut.inc.php,v 1.11.2.1 2017-09-14 14:45:29 tsamson Exp $
...
function show_statut($dbh) {
	...
	for($i=0;$i<$nbr;$i++) {
		...
		if($row->allow_scan_request) print "<td>X</td>";
		else print "<td>&nbsp;</td>";
		if($row->allow_contribution) print "<td>X</td>";
		else print "<td>&nbsp;</td>";
		print "</tr>";
		}
	print "</table>
