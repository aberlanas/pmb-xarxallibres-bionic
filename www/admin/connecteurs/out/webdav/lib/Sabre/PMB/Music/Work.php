...
// +-------------------------------------------------+
// $Id: Work.php,v 1.5 2016-03-21 16:11:36 vtouchard Exp $
...
class Work extends Collection {
	...
	function getNotices(){
		$this->notices = array();
		$vedette_composee_found = \vedette_composee::get_vedettes_built_with_element($this->titre_uniforme->id, "titre_uniforme");
		$concepts_ids = array();
