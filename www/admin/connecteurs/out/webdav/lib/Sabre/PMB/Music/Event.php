...
// +-------------------------------------------------+
// $Id: Event.php,v 1.4 2016-02-11 10:13:41 apetithomme Exp $
		...
		if($this->authperso->id){
			...
			if(pmb_mysql_num_rows($result)){
				while($row = pmb_mysql_fetch_object($result)){
					$vedette_composee_found = \vedette_composee::get_vedettes_built_with_element($row->tu_id, "titre_uniforme");
