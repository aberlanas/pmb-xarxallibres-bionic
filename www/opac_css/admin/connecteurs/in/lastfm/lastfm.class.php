...
// +-------------------------------------------------+
// $Id: lastfm.class.php,v 1.11 2017-07-12 15:14:59 tsamson Exp $
...
class lastfm extends connector {
	...
	public function get_pagin_form($infos){
		...
		if($current>0){
			...
			if($current > 1) $ret .= "<img src='images/prev.png' onclick='switch_lastfm_page(\"".$this->noticeToEnrich."\",\"".$this->typeOfEnrichment."\",\"".$current."\",\"previous\");'/>";
			else $ret .= "<img src='images/prev-grey.png'/>";
			$ret .="&nbsp;".$current."/$nb_page&nbsp;";
			if($current < $nb_page) $ret .= "<img src='images/next.png' onclick='switch_lastfm_page(\"".$this->noticeToEnrich."\",\"".$this->typeOfEnrichment."\",\"".$current."\",\"next\");' style='cursor:pointer;'/>";
			else $ret .= "<img src='images/next-grey.png'/>";
