...
// +-------------------------------------------------+
// $Id: babelio.class.php,v 1.10 2017-01-30 14:09:09 dgoron Exp $
...
class babelio extends connector {
	...
	public function getEnrichmentPagin($sommaire){
		...
		$ret = "";
		if($current > 1) $ret .= "<img src='images/prev.png' onclick='switchPage(\"".$this->noticeToEnrich."\",\"".$this->typeOfEnrichment."\",\"".$current."\",\"previous\");'/>";
		else $ret .= "<img src='images/prev-grey.png'/>";
		$ret .="&nbsp;".$current."/$nb_page&nbsp;";
		if($current < $nb_page) $ret .= "<img src='images/next.png' onclick='switchPage(\"".$this->noticeToEnrich."\",\"".$this->typeOfEnrichment."\",\"".$current."\",\"next\");'/>";
