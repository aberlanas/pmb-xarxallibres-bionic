...
// +-------------------------------------------------+
// $Id: set-grid-main-uncolored.js,v 1.14.2.9 2018-01-25 16:37:00 wlair Exp $ */
// grid test
$(document).ready(function () {
	...
	imgEvents();
	//Pixel blanc fin
	$("div:empty").not(".cms_module_agenda *").not("div[class*='dijit']").not("#att").addClass("ui-empty-item");
	$("body").addClass("ready");
});
