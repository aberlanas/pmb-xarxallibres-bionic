...
// +-------------------------------------------------+
// $Id: category_browse.php,v 1.1.2.6 2018-01-18 09:33:23 jpermanne Exp $
//
...
."&max_field=".$max_field."&field_id=".$field_id."&field_name_id=".$field_name_id."&add_field=".$add_field."&page=!!page!!&parent="; // attention parent doit etre le dernier!!
