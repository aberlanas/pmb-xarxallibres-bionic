...
// +-------------------------------------------------+
// $Id: etagere_see.inc.php,v 1.56.2.3 2018-02-09 11:35:09 dgoron Exp $
...
if ($id) {
	...
	if($nbr_lignes) {
		...
		print "<span class=\"printEtagere\">
				<a href='#' onClick=\"openPopUp('".$base_path."/print.php?lvl=etagere&id_etagere=".$id."','print',500,600,-2,-2,'scrollbars=yes,menubar=0'); w.focus(); return false;\" title=\"".$msg["etagere_print"]."\">
					<img src='".get_url_icon('print.gif')."' border='0' align='bottom' alt=\"".$msg["etagere_print"]."\"/>
				</a>
			</span>";
