...
// +-------------------------------------------------+
// $Id: explnum.inc.php,v 1.54 2017-07-21 08:34:40 vtouchard Exp $
	...
	if ($nb_ex && ($docnum_visible || $opac_show_links_invisible_docnums)) {
		...
		while (($expl = pmb_mysql_fetch_object($res))) {
			...
			if ($explnum_docnum_visible ||  $opac_show_links_invisible_docnums) {
				...
				if ($i==1) $ligne="<tr><td !!td_id_1!! class='docnum' width='33%'>!!1!!</td><td  !!td_id_2!! class='docnum' width='33%'>!!2!!</td><td !!td_id_3!! class='docnum' width='33%'>!!3!!</td></tr>" ;
				$tlink = '';
				if ($link_expl) {
