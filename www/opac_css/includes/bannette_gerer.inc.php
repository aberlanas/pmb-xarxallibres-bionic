...
// +-------------------------------------------------+
// $Id: bannette_gerer.inc.php,v 1.13.2.1 2017-11-14 14:31:43 dgoron Exp $
...
if ($opac_allow_resiliation) {
	$aff = $bannette_abon_instance->gerer_abon_bannette ("PUB", "./empr.php?lvl=bannette&id_bannette=!!id_bannette!!" ) ;
	if ($aff) 
...
if ($opac_allow_bannette_priv) {
	$aff = $bannette_abon_instance->gerer_abon_bannette ("PRI", "./empr.php?lvl=bannette&id_bannette=!!id_bannette!!" ) ;
	if ($aff)
