...
// +-------------------------------------------------+
// $Id: index_includes.inc.php,v 1.147.2.4 2018-01-26 16:15:13 dgoron Exp $
...
<a href='#' onClick=\"openPopUp('".$base_path."/print.php?lvl=search&current_search=".($_SESSION['last_query']+0)."','print',500,600,-2,-2,'scrollbars=yes,menubar=0'); w.focus(); return false;\" title=\"".$msg["histo_print_current_page"]."\">
	<img src='".get_url_icon('print.gif')."' border='0' align='bottom' alt=\"".$msg["histo_print_current_page"]."\"/>
</a>
</span>";
...
if ($opac_show_bandeaugauche==0) {
	...
	$footer=str_replace("!!contenu_bandeau!!",($opac_accessibility ? $accessibility : "").$home_on_left.$loginform.$meteo.($opac_facette_in_bandeau_2?"":$lvl1.$map_location_search.$facette).$adresse,$footer);
	$footer= str_replace("!!contenu_bandeau_2!!",$opac_facette_in_bandeau_2?$lvl1.$map_location_search.$facette:"",$footer);
} 
print $footer;
if($opac_parse_html || $cms_active){	
	if($opac_parse_html){
