...
// +-------------------------------------------------+
// $Id: common.tpl.php,v 1.235.2.8 2018-01-23 16:44:16 wlair Exp $
...
if(($opac_map_activate==1 || $opac_map_activate==3) && ($lvl=="more_results" || strpos($lvl,"_see")) !== false){
	$map_location_search ="
...
if($opac_recherche_ajax_mode){
	if($opac_recherche_show_expand){
		$begin_result_liste = "<span class=\"expandAll\"><a href='javascript:expandAll_ajax(".$opac_recherche_ajax_mode.");$simili_search_call'><img class='img_plusplus' src='".get_url_icon("expand_all.gif")."' border='0' id='expandall'></a></span>".$begin_result_liste."<span class=\"collapseAll\"><a href='javascript:collapseAll()'><img class='img_moinsmoins' src='".get_url_icon("collapse_all.gif")."' border='0' id='collapseall'></a></span>";
	}
}else{
	if($opac_recherche_show_expand){
		$begin_result_liste = "<span class=\"expandAll\"><a href='javascript:expandAll()'><img class='img_plusplus' src='".get_url_icon("expand_all.gif")."' border='0' id='expandall'></a></span>".$begin_result_liste."<span class=\"collapseAll\"><a href='javascript:collapseAll()'><img class='img_moinsmoins' src='".get_url_icon("collapse_all.gif")."' border='0' id='collapseall'></a></span>";
	}
}
