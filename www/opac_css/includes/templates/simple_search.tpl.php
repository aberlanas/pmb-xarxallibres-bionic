...
// +-------------------------------------------------+
// $Id: simple_search.tpl.php,v 1.47.2.2 2018-01-25 10:15:19 dgoron Exp $
...
switch ($search_type) {
	...
	case "external_search":
		$search_input = "
			...
			if ($opac_show_help) $search_input .= "<input type='button' value='$msg[search_help]' class='bouton' onClick='window.open(\"$base_path/help.php?whatis=simple_search\", \"search_help\", \"scrollbars=yes, toolbar=no, dependent=yes, width=400, height=400, resizable=yes\"); return false' />\n";
			$search_input .= "<!--!!ou_chercher!!-->\n
				<br /><a href='javascript:expandAll()'><img class='img_plusplus' src='".get_url_icon("expand_all.gif")."' border='0' id='expandall'></a>&nbsp;<a href='javascript:collapseAll()'><img class='img_moinsmoins' src='".get_url_icon("collapse_all.gif")."' border='0' id='collapseall'></a>
