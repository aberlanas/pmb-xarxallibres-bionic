...
<div id='contact_form_content'>
	<script type='text/javascript'>
		function contact_form_send(form) {
			var url= './ajax.php?module=ajax&categ=contact_form&sub=form&action=send_mail';
			var req = new http_request();
			req.request(url, true, '&form_fields='+dojo.formToJson(contact_form));
	...
	<div class='form-contenu'>
		...
		<div class='contact_form_text'>
			<div class='colonne2'>
				<label for='contact_form_text'>".htmlentities($msg['contact_form_text'.$name], ENT_QUOTES, $charset)."</label>
	...
	<div class='row'>
		...
		<div class='colonne2'>
			<input type='button' class='bouton' value=\"".$msg['contact_form_button_send']."\" onclick=\"if(dijit.byId('contact_form').validate()) { contact_form_send(); } return false;\" />
		</div>
	</div>
	</form>
</div>
