...
// +-------------------------------------------------+
// $Id: sort.tpl.php,v 1.10.2.1 2018-01-25 10:15:19 dgoron Exp $
...
<td alt='".$msg['appliq_tri']."' title='".$msg['appliq_tri']."'><a href='./index.php?!!page_en_cours1!!&get_last_query=".(isset($_SESSION["last_query"]) ? $_SESSION["last_query"] : '')."&sort=!!id_tri!!'>!!nom_tri!!</a></td> 
</tr>
";	    		
