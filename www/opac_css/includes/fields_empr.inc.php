...
// +-------------------------------------------------+
// $Id: fields_empr.inc.php,v 1.85.2.3 2017-09-18 13:24:09 dgoron Exp $
...
function aff_query_auth_empr_search($field,&$check_scripts,$varname) {
	...
	$ret.="
		...
		<span class='search_dico'><img src='".get_url_icon("dictionnaire.png")."' align='middle' onClick=\"document.getElementById('$fnamesanslib').focus();simulate_event('$fnamesanslib');\"></span>
...
function get_js_function_dnd($field_type, $field_name) {
	global $base_path;
	return "
		<script type='text/javascript' src='".$base_path."/javascript/customfield_drop.js'></script>
		<script type='text/javascript'>
