...
// +-------------------------------------------------+
// $Id: simple_search.inc.php,v 1.133.2.6 2018-02-12 10:27:33 dgoron Exp $
...
function simple_search_content($value='',$css) {
	...
	global $map_emprises_query, $opac_map_bounding_box;
...
function do_ou_chercher () {
	...
	*/
	...
	if ($opac_modules_search_all>0) $ou_chercher_tab[] = "\n<span style='width: 30%; float: left;'><input type='checkbox' name='look_ALL' id='look_ALL' value='1' $checked_ALL $cant_uncheck_look_all title='toto' /><label for='look_ALL'> ".$msg['tous']." </label></span>";
...
function do_sources() {
    ...
    $paquets_de_source["id"] = 0;
    $paquets_de_source["name"] = '';
    $paquets_de_source["content"] = '';
    $paquets_de_source["opac_expanded"] = '';
