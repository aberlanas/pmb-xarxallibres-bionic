...
// +-------------------------------------------------+
// $Id: rec_history.inc.php,v 1.47 2017-07-12 15:15:01 tsamson Exp $
...
function get_human_query_level_two($n) {
	...
	if ($_SESSION["search_type".$n]=="simple_search") {
		...
		$r=sprintf($msg["simple_search_history"],(!$valeur_champ? (isset($_SESSION["user_query".$n]) ? stripslashes($_SESSION["user_query".$n]) : ''):$valeur_champ),$r1,$r2);
