...
// +-------------------------------------------------+
// $Id: show_cart.inc.php,v 1.68.2.1 2017-09-05 14:44:24 jpermanne Exp $
...
if (count($cart_)) {
	...
	print '<div id="cart_navbar"><hr /><center>'.printnavbar($page, count($cart_), $opac_search_results_per_page, './index.php?lvl=show_cart&page=!!page!!&nbr_lignes='.count($cart_).($nb_per_page_custom ? "&nb_per_page_custom=".$nb_per_page_custom : '')).'</center></div>';
} else {
