...
// +-------------------------------------------------+
// $Id: authperso.inc.php,v 1.3.6.1 2018-01-18 08:30:14 wlair Exp $
...
print pmb_bidi("<h3 class='searchResult-search'><span class='searchResult-equation'>$count ".$name." <b>'".htmlentities(stripslashes($user_query),ENT_QUOTES,$charset)."'");
