...
// +-------------------------------------------------+
// $Id: collection.inc.php,v 1.24.6.1 2018-01-18 08:30:14 wlair Exp $
...
if(!$opac_allow_affiliate_search || ($opac_allow_affiliate_search && $tab == "catalog")){
	print "
			<h3 class='searchResult-search'><span class='searchResult-equation'><b>$count</b> $msg[collections_found] <b>'".htmlentities(stripslashes($user_query),ENT_QUOTES,$charset)."'";
