...
// +-------------------------------------------------+
// $Id: subcollection.inc.php,v 1.25.6.1 2018-01-18 08:30:14 wlair Exp $
...
if(!$opac_allow_affiliate_search || ($opac_allow_affiliate_search && $tab == "catalog")){
	...
	print pmb_bidi("	<h3 class='searchResult-search'><span class='searchResult-equation'>$count $msg[subcolls_found] <b>'".htmlentities(stripslashes($user_query),ENT_QUOTES,$charset)."'");
