...
// +-------------------------------------------------+
// $Id: extended.inc.php,v 1.29.2.1 2018-01-24 09:04:24 jpermanne Exp $
...
if (!$flag) {
	...
	if($opac_allow_affiliate_search && $allow_search_affiliate_and_external){
		...
		if($nb_result_extended){
			$link = "<a href='#' onclick=\"document.search_form.action = './index.php?lvl=more_results&mode=extended&tab=catalog'; enable_operators(); document.search_form.submit();return false;\">".$msg['suite']."&nbsp;<img src='./images/search.gif' border='0' align='absmiddle'/></a>";
		}else $link = "";
		...
		if ($nb_result_extended) {
			...
			print "<a href=\"#\" onclick=\"document.search_form.action='./index.php?lvl=more_results&mode=extended'; enable_operators(); document.search_form.submit(); return false;\">$msg[suite]&nbsp;<img src='./images/search.gif' border='0' align='absmiddle'/></a><br /><br />";
		}
	}	
