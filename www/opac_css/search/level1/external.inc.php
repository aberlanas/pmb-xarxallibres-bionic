...
// +-------------------------------------------------+
// $Id: external.inc.php,v 1.15.2.1 2017-09-21 12:40:17 jpermanne Exp $
...
if ($_SESSION["ext_type"]=="multi") {
	...
	if (!$flag) {
		...
		if ($nb_result_external) {
			...
			print "<a href=\"#\" onclick=\"document.external_extended_form.submit(); return false;\">$msg[suite]&nbsp;<img src='./images/search.gif' border='0' align='absmiddle'/></a><br /><br />";
		}
	}
} else {
	//Recherche "simple"
