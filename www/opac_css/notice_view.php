...
// +-------------------------------------------------+
// $Id: notice_view.php,v 1.15.2.1 2017-11-22 14:51:56 wlair Exp $
...
$templates .= "<!--<div id='bouton_fermer_notice_preview' class='right'><a href='#' class='panel-close' onClick='parent.kill_frame();return false;'><i class='fa fa-times' aria-hidden='true'></i></a></div>//-->
			<div id='notice'>
				#FILES
			</div>
		</body>
