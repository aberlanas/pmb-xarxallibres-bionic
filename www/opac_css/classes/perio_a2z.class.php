...
// +-------------------------------------------------+
// $Id: perio_a2z.class.php,v 1.71.2.2 2018-01-30 13:35:31 jpermanne Exp $
...
class perio_a2z {
	...
	// ---------------------------------------------------------------
	public function __construct($bull_id=0,$abecedaire=0,$max_per_onglet=12){
		// A MODIFIER!!
	...
	public function filter($start) {
		$this->start=$start;
		$titles=array_filter($this->titles,array($this,'startwith'));
		return $titles;
	}
	
	public function filterSearch($start,$datas) {
		global $dbh;
