...
// +-------------------------------------------------+
// $Id: facette_search_compare.class.php,v 1.23.2.2 2017-08-18 09:24:13 mbertin Exp $
...
class facette_search_compare {
	...
	public static function get_begin_result_list(){
		...
		return "<a href='javascript:expandAll_compare();'>
					<img class='img_plusplus' src='".get_url_icon("expand_all.gif",1)."' border='0' id='expandall'>
				</a>
				&nbsp;
				<a href='javascript:collapseAll_compare()'>
					<img class='img_moinsmoins' src='".get_url_icon("collapse_all.gif",1)."' border='0' id='collapseall'>
				</a>
		";
	}
