...
// +-------------------------------------------------+
// $Id: notice_affichage_unimarc.class.php,v 1.70.2.3 2018-01-26 15:37:55 dgoron Exp $
	...
	public function aff_suite() {
		...
		if ($this->notice->lien) {
			...
			if (substr($this->notice->eformat,0,3)=='RSS') {
				...
				$ret.="<a href=\"".$lien."\" target=\"top\">".htmlentities($this->notice->lien_texte?$this->notice->lien_texte:$lien,ENT_QUOTES,$charset)."</a>";
			}
			$ret.="</td></tr>";
