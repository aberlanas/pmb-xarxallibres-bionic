...
// +-------------------------------------------------+
// $Id: searcher_autorities_skos_concepts.class.php,v 1.1 2017-01-06 16:10:51 tsamson Exp $
	...
	public function _get_search_type(){
 	...
 	protected function _sort($start,$number){
 		...
 		if($this->table_tempo != ""){
 			...
 			$query = "select ".$this->table_tempo.".".$this->object_key." from ".$this->object_fields_table." where code_champ= 1 and code_ss_champ = 1 and ".$this->object_fields_table.".".$this->object_index_key." in (".$this->get_result().") order by ".$this->object_fields_table.".".$this->object_fields_value." asc limit ".$start.",".$number;
 		}
