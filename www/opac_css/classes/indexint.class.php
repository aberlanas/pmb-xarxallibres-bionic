...
// +-------------------------------------------------+
// $Id: indexint.class.php,v 1.31.2.1 2017-09-18 14:33:48 dgoron Exp $
...
class indexint {
	...
	public function child_list($image='./images/folder.gif',$css, $dest=0) {
		...
		while(list($cle, $valeur) = each($this->childs)) {
			...
			$id = $valeur['idchild'];
			$l .=  "<a href=./index.php?lvl=indexint_see&id=$id&main=$main ><img src='".get_url_icon('folder.gif')."' border='0'> ".$libelle."</a>";
			$l .= "<br />";
			}
