...
// +-------------------------------------------------+
// $Id: frbr_entity_subcollections_view_subcollectionslist.class.php,v 1.2 2017-05-16 09:00:44 dgoron Exp $
...
{% endfor %}
	...
	public function render($datas){	
		...
		if(is_array($datas)){
			foreach($datas as $subcollection_id){
				$subcollection = new subcollection($subcollection_id);
				$infos= $subcollection->format_datas();
				$render_datas['subcollections'][]=$infos;
			}
		}
		//on rappelle le tout...
	...
	public function get_format_data_structure(){		
		...
		$subcollections = array(
			...
			'children' => $this->prefix_var_tree(subcollection::get_format_data_structure(),"subcollections[i]")
		);
