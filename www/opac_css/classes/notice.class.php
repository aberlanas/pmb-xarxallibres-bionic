...
// +-------------------------------------------------+
// $Id: notice.class.php,v 1.39.2.4 2017-10-25 15:15:30 dgoron Exp $
...
class notice {
	...
	public function print_resume($level = 2,$css)	{
		...
		if ($as!== FALSE && $as!== NULL) {
			...
			$mention_resp_lib = "<b>".$msg['auteur_start']."</b> "."<a href='index.php?lvl=author_see&id=".$auteur_0["id"]."' title='".$auteur->info_bulle."'>".$auteur->get_isbd()."</a> ".$f_auteur."<br />";
		...
		for ($i = 0 ; $i < count($as) ; $i++) {
			...
			$mention_resp_lib = "<b>".$msg['auteur_start']."</b> "."<a href='index.php?lvl=author_see&id=".$auteur_1["id"]."' title='".$auteur->info_bulle."'>".$auteur->get_isbd()."</a> ".$f_auteur."<br />";
			$mention_resp[] = $mention_resp_lib ;
		}
		...
		for ($i = 0 ; $i < count($as) ; $i++) {
			...
			$mention_resp_lib = "<b>".$msg['auteur_start']."</b> "."<a href='index.php?lvl=author_see&id=".$auteur_2["id"]."' title='".$auteur->info_bulle."'>".$auteur->get_isbd()."</a> ".$f_auteur."<br />";
			$mention_resp[] = $mention_resp_lib ;
		}
