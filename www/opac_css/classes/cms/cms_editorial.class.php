...
// +-------------------------------------------------+
// $Id: cms_editorial.class.php,v 1.42 2017-07-12 15:15:01 tsamson Exp $
...
class cms_editorial extends cms_root {
	...
	public function get_permalink(){
		...
		$view_string = '';
		if($opac_opac_view_activate){ //On doit rajouter la vue dans l'url
			if(isset($_SESSION['opac_view'])){
				$view_string.= '&opac_view='.$_SESSION['opac_view'];
			}
		}
		if($this->num_page && $this->var_name){ //Le type d'élément sur lequel on se trouve a une page et une variable d'environnement renseignés
			return "./index.php?lvl=cmspage&pageid=".$this->num_page."&".$this->var_name."=".$this->id.$view_string; 
		}
		return '';
	}
