...
// +-------------------------------------------------+
// $Id: contribution_area_form.class.php,v 1.5.2.2 2017-12-27 09:47:01 apetithomme Exp $
	...
	public function get_active_properties() {	
		...
		if ($this->unserialized_parameters) {			
			foreach($this->unserialized_parameters as $key => $param){
				...
				$this->active_properties[$uri]->equation = $this->unserialized_parameters->$key->equation;				
				$this->active_properties[$uri]->readonly = $this->unserialized_parameters->$key->readonly;				
