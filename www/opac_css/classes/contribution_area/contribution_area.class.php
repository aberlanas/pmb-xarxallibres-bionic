...
// +-------------------------------------------------+
// $Id: contribution_area.class.php,v 1.4.2.1 2017-09-14 14:45:29 tsamson Exp $
...
class contribution_area {
	...
	public function render () {
		global $include_path;
		$h2o = new H2o($include_path .'/templates/contribution_area/contribution_area.tpl.html');
		$h2o->set(array('contribution_area' => $this));
		return $h2o->render();
	}
