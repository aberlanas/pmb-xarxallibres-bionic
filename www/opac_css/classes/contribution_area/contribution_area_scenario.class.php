...
// +-------------------------------------------------+
// $Id: contribution_area_scenario.class.php,v 1.4.2.1 2018-02-05 09:08:19 vtouchard Exp $
...
class contribution_area_scenario {
	...
	public function render() {
		global $include_path;
		$h2o = new H2o($include_path .'/templates/contribution_area/contribution_area_scenario.tpl.html');
		$h2o->set(array('scenario' => $this));
		return $h2o->render();
	}
