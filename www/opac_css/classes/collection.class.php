...
// +-------------------------------------------------+
// $Id: collection.class.php,v 1.28 2017-06-09 08:23:02 ngantier Exp $
		...
		if($this->id) {
			...
			if(pmb_mysql_num_rows($result)) {
				...
				if($row->collection_web) 
					$this->collection_web_link = " <a href='$row->collection_web' target=_blank title='".htmlentities($row->collection_web,ENT_QUOTES,$charset)."' alt='".htmlentities($row->collection_web,ENT_QUOTES,$charset)."' type='external_url_autor' ><img src='".get_url_icon("globe.gif")."' border=0 /></a>";
