...
// +-------------------------------------------------+
// $Id: listes_lecture.class.php,v 1.7 2017-02-10 10:30:33 dgoron Exp $
...
class listes_lecture {
			...
			$display .= "
				&nbsp;<span>
					<a href='./empr.php?lvl=demande_list&tab=lecture'>
						<img border=0 align='middle' src='".get_url_icon('notification_new.png', 1)."' title=\"".$msg['list_lecture_ask_in_progess']."\"/>
					</a>			
				</span>";
		}
		$display .= "</div>";
	...
	protected function get_display_public_reading_list($liste) {
		...
		if($icone) $display .= "<span><img border=0 align='top' src='".get_url_icon($icone, 1)."' title=\"".$title."\" id='img_confi_".$liste->id_liste."' /></span>";
		if($liste->read_only){
			$display .= "&nbsp;<span><img border=0 align='top' src='".get_url_icon('b_no_edit.png', 1)."' title=\"".$msg['list_lecture_readonly']."\" id='img_ro_".$liste->id_liste."' /></span>";
		}
		$display .= "</div>";
