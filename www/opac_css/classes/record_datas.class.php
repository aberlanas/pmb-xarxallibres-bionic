...
// +-------------------------------------------------+
// $Id: record_datas.class.php,v 1.72.2.10 2018-01-26 15:37:55 dgoron Exp $
	...
	public function get_auteurs_principaux() {
		if (!$this->auteurs_principaux) {
			...
			if (($as !== FALSE) && ($as !== NULL)) {
				...
				$this->auteurs_principaux = "<a href='index.php?lvl=author_see&id=".$auteur_0['id']."'>".$auteur_0["auteur_titre"]."</a>";
			} else {
				...
				for ($i = 0; $i < count($as); $i++) {
					...
					if($auteur_1["type"]==72 || $auteur_1["type"]==71) {
						...
						$aut1_libelle[]="<a href='index.php?lvl=author_see&id=".$auteur_1['id']."'>".$congres->display."</a>";
					} else {
						$aut1_libelle[]= "<a href='index.php?lvl=author_see&id=".$auteur_1['id']."'>".$auteur_1["auteur_titre"]."</a>";
					}
				}
		...
		if (!$this->auteurs_secondaires) {
			...
			for ($i = 0; $i < count($as); $i++) {
				...
				if($auteur_2["type"]==72 || $auteur_2["type"]==71) {
					...
					$aut2_libelle[]="<a href='index.php?lvl=author_see&id=".$auteur_2['id']."'>".$congres->display."</a>";
				} else {
					$aut2_libelle[]="<a href='index.php?lvl=author_see&id=".$auteur_2['id']."'>".$auteur_2["auteur_titre"]."</a>";
				}
			}
