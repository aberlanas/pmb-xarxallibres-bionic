...
// +-------------------------------------------------+
// $Id: onto_contribution_datatype_docnum_file.class.php,v 1.3.2.1 2017-12-27 09:47:01 apetithomme Exp $
	...
	public static function get_values_from_form($instance_name, $property, $uri_item) {
		...
		if(count($file)) {
			if (isset(${$var_directory}) && ${$var_directory}[0]['value']) {
				...
				$file_path = self::get_valid_file_path($upload_folder->repertoire_path.$path.$file['name'][0]['value']);
